...
def main():
    ...
    if duplicates:
        ...
        print("    These files should be merged or renamed:")
    ...
    if heads:
        ...
        print("  Command: alembic merge -m 'consolidate migration heads'")
    else:
    ...
    if len(chains) > 1:
        ...
        print("   This indicates migration branches that need merging")
    else:
    ...
    sum(1 for _, result in status_checks if result)
