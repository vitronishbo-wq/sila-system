...
def run_command(cmd, description):
    ...
    try:
        result = subprocess.run(
            cmd, cwd="/home/dev03wsl/sila-system", capture_output=True, text=True, timeout=30
        )
...
def test_code_quality():
    ...
    print("\n  2. Code Linting (ruff)")
    returncode, stdout, stderr = run_command(
        ["python", "-m", "ruff", "check", "apps/backend/app/modules/economy"], "Lint economy module"
    )
    ...
    try:
        print("     Status: ✅ PASSED")
        print("     Core layers import successfully")
    except Exception as e:
        print("     Status: ❌ FAILED")
...
def main():
    ...
    try:
        ...
        passed_endpoints + passed_errors
        ...
        print("  Code Quality: Checked (mypy, ruff, imports)")
