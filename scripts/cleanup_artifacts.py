...
Purpose:
  ...
  when operating outside permitted scopes defined in AI_FILE_SCOPE.yaml
...
class ArtifactCleaner:
    ...
    def summary(self):
        ...
        if self.dry_run:
            ...
            print(f"✅ CLEANUP COMPLETE: {self.removed_count}/{len(self.artifacts)} "
...
def main():
    ...
    parser.add_argument('--auto', action='store_true',
                       help='Remove without confirmation prompts')
