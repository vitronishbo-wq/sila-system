...
DEFAULT_REPLACEMENTS: list[tuple[re.Pattern[str], str]] = [
    ...
    (re.compile(r"\bfrom\s+app\.citizen\.core\.models\b"), "from app.modules.identity.core.models"),
    (re.compile(r"\bimport\s+app\.citizen\.core\.models\b"), "import app.modules.identity.core.models"),
    (re.compile(r"\bfrom\s+app\.citizen\.service\b"), "from app.modules.identity.service"),
    (re.compile(r"\bimport\s+app\.citizen\.service\b"), "import app.modules.identity.service"),
    (re.compile(r"\bfrom\s+app\.citizen\.enums\b"), "from app.modules.identity.enums"),
    (re.compile(r"\bimport\s+app\.citizen\.enums\b"), "import app.modules.identity.enums"),
    (re.compile(r"\bfrom\s+app\.citizen\.exceptions\b"), "from app.modules.identity.exceptions"),
    (re.compile(r"\bimport\s+app\.citizen\.exceptions\b"), "import app.modules.identity.exceptions"),
    (re.compile(r"\bfrom\s+app\.citizen\.events\.models\b"), "from app.modules.identity.events.models"),
    (re.compile(r"\bimport\s+app\.citizen\.events\.models\b"), "import app.modules.identity.events.models"),
    (re.compile(r"\bfrom\s+app\.citizen\.projections\.projectors\b"), "from app.modules.identity.projections.projectors"),
    (re.compile(r"\bimport\s+app\.citizen\.projections\.projectors\b"), "import app.modules.identity.projections.projectors"),
]
