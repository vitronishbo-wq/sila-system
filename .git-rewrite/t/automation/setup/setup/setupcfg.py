...
def _apply(dist: "Distribution", filepath: _Path,
...
def parse_configuration(distribution: "Distribution",
    ...
    with expand.EnsurePackagesDiscovered(distribution) as ensure_discovered:
        ...
        meta = ConfigMetadataHandler(distribution.metadata,
            command_options,
            ignore_option_errors,
            ensure_discovered,
...
def _warn_accidental_env_marker_misconfig(label: str, orig_value: str, parsed: list):
    ...
    with contextlib.suppress(InvalidRequirement):
        ...
        if req.marker is not None:
            msg = (f"One of the parsed requirements in `{label}` "
...
class ConfigHandler(Generic[Target]):
    ...
    def _exclude_files_parser(cls, key):
        ...
        def parser(value):
            ...
            if value.startswith(exclude_directive):
                raise ValueError('Only strings are accepted for the {0} field, '
    ...
    def parse(self):
        ...
        for section_name, section_options in self.sections.items():
            ...
            section_parser_method: Optional[Callable] = getattr(self,
...
class ConfigMetadataHandler(ConfigHandler["DistributionMetadata"]):
    ...
    def parsers(self):
        ...
        return {
            ...
            'license_file': self._deprecated_config_handler(exclude_files_parser('license_file'),
...
class ConfigOptionsHandler(ConfigHandler["Distribution"]):
    ...
    def parsers(self):
        ...
        return {
            ...
            'namespace_packages': self._deprecated_config_handler(parse_list,
    ...
    def _parse_packages(self, value):
        ...
        find_kwargs.update(namespaces=(trimmed_value == find_directives[1]),
    ...
    def parse_section_extras_require(self, section_options):
        ...
        :param dict section_options:
        """
        parsed = self._parse_section_to_dict_with_key(section_options,
