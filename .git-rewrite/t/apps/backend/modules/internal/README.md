...
Módulo responsável pelas funcionalidades relacionadas a INTERNAL no sistema SILA.
...
DELETE | /internal/\* | Operações CRUD básicas |
...
```python
from app.modules.internal import router
