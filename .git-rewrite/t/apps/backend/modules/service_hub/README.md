...
Módulo responsável pelas funcionalidades relacionadas a SERVICE_HUB no sistema SILA.
...
DELETE | /service_hub/\* | Operações CRUD básicas |
...
```python
from app.modules.service_hub import router
