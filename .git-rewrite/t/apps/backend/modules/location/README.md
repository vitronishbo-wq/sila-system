...
Módulo responsável pelas funcionalidades relacionadas a LOCATION no sistema SILA.
...
DELETE | /location/\* | Operações CRUD básicas |
...
```python
from app.modules.location import router
