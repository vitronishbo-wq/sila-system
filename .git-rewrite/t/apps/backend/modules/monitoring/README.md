...
Módulo responsável pelas funcionalidades relacionadas a MONITORING no sistema SILA.
...
DELETE | /monitoring/\* | Operações CRUD básicas |
...
```python
from app.modules.monitoring import router
