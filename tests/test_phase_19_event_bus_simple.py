...
class TestDomainEvent:
    ...
    def test_event_to_dict(self):
        """Event serialization"""
        event = DomainEvent(name="TEST", payload={"data": "value"})
...
class TestPhase19Components:
    ...
    def test_workers_exist(self):
        """Workers available"""
        from apps.backend.app.core.events.workers.event_worker import EventWorker
        from apps.backend.app.core.events.workers.outbox_worker import OutboxWorker
...
NEXT STEPS:
  ...
  2. Create outbox table: python -m apps.backend.app.core.events.setup
