...
class TestPhase18_3LocalOrchestration:
    ...
    def test_alertmanager_devops_config_exists(self):
        ...
        devops_alertmanager = self.SILA_ROOT / "platform/devops/monitoring/grafana/provisioning/alerting/alertmanager.yml"
    ...
    def test_endpoints_normalized_in_devops_prometheus(self):
        ...
        assert "alertmanager:9093" not in content, "Devops Prometheus still references container DNS"
        
        # Should contain localhost
        assert "localhost:9093" in content, "Devops Prometheus missing localhost endpoint"
        assert "localhost:9100" in content or "localhost:9100" in content, "Devops Prometheus missing node-exporter endpoint"
    ...
    def test_endpoints_normalized_in_devops_alertmanager(self):
        ...
        assert "alertmanager:9093" not in content, "Devops Alertmanager still references container DNS"
    ...
    def test_anomaly_detector_module_exists(self):
        ...
        anomaly_detector = self.SILA_ROOT / "apps/backend/app/core/observability/anomaly_detector.py"
    ...
    def test_critical_ports_configured(self):
        ...
        for port_name, default_value in critical_ports.items():
