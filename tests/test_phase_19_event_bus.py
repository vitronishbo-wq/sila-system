...
from apps.backend.app.core.events.models.user_events import UserLoggedIn
...
class TestUserEvents:
    ...
    def test_user_logged_in_event(self):
        ...
        event = UserLoggedIn(user_id="user123", request_id="req456")
...
class TestEventBus:
    ...
    async def test_event_bus_publish(self):
        ...
        from apps.backend.app.core.events.bus.event_bus_v2 import EventBus
...
class TestPhase19Compliance:
    ...
    def test_handlers_module_complete(self):
        ...
        from apps.backend.app.core.events.handlers.example_handlers import (
...
NEXT ACTIONS
   ...
   2. Run Outbox Worker: python -m apps.backend.app.core.events.workers.outbox_worker
   3. Run Event Worker: python -m apps.backend.app.core.events.workers.event_worker
