...
Revision ID: 004_add_health_indexes
Revises: 003_create_health_tables
Create Date: 2026-02-18
"""
from alembic import op

revision = '004_add_health_indexes'
down_revision = '003_create_health_tables'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_index('ix_appointments_citizen_date', 'appointments', ['citizen_id', 'appointment_date'])
