...
async def upload_document(citizen_id: UUID=Form(...), doc_type: DocumentTypeEnum=Form(...), file: UploadFile=File(...), repo: CitizenDocumentRepository=Depends(get_repo)):
...
async def get_latest_document(citizen_id: UUID, doc_type: DocumentTypeEnum, repo: CitizenDocumentRepository=Depends(get_repo)):
...
async def list_document_versions(citizen_id: UUID, doc_type: DocumentTypeEnum, repo: CitizenDocumentRepository=Depends(get_repo)):
