...
def protected_endpoints() -> list[tuple[str, str, dict]]:
    ...
    return [
        ...
        (
            "POST",
            "/api/citizen/certidoes/solicitar",
            {"certificate_type": "nascimento", "quantity": 1},
        ),
        ("GET", "/api/citizen/atestados", {}),
        ("POST", "/api/citizen/atestados/solicitar", {"attestation_type": "residencia"}),
        ...
        ("POST", "/api/v1/identidade/bi/renovar", {"citizen_fuc_id": "CITIZEN-001"}),
        ("POST", "/api/v1/identidade/bi/cancelar", {"citizen_fuc_id": "CITIZEN-001"}),
        ...
        ("POST", "/api/v1/identidade/atestados/residencia", {"citizen_fuc_id": "CITIZEN-001"}),
        (
            "POST",
            "/api/v1/identidade/atestados/vida-e-identidade",
            {"citizen_fuc_id": "CITIZEN-001"},
        ),
        (
            "POST",
            "/api/v1/service-requests/",
            {"service_type": "IDENTIDADE_BI", "title": "Test", "description": "Test"},
        ),
        ...
        (
            "POST",
            f"/api/v1/service-requests/{uuid4()}/assign",
            {"assigned_to_user_id": str(uuid4())},
        ),
        ("PATCH", f"/api/v1/service-requests/{uuid4()}/status", {"status": "EM_ANALISE"}),
        ("POST", "/api/v1/service-requests/search", {"query": "test", "skip": 0, "limit": 10}),
...
def auth_test_summary(protected_endpoints) -> str:
    ...
    by_method = {}
    for method, _endpoint, _ in protected_endpoints:
