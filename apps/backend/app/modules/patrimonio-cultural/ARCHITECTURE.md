...
Domain: patrimonio-cultural

Path:
/home/dev03wsl/sila-system/apps/backend/app/modules/patrimonio-cultural

## Purpose

Gerir capacidades do dominio governamental `patrimonio-cultural` no contexto federado `unknown`.

## Core Responsibilities

- Modelar regras de negocio do modulo `patrimonio-cultural`.
