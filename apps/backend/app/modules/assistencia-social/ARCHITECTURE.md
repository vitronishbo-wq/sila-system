...
Path:
/home/dev03wsl/sila-system/apps/backend/app/modules/assistencia-social

## Purpose

Gerir capacidades do dominio governamental `assistencia-social` no contexto federado `unknown`.

## Core Responsibilities

- Modelar regras de negocio do modulo `assistencia-social`.
