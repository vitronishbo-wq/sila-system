...
from app.modules.registo_civil.application.services.birth_service import BirthService
...
def get_birth_service(db=Depends(get_db)):
    from app.modules.registo_civil.infrastructure.repositories.birth_repository import BirthRepository
