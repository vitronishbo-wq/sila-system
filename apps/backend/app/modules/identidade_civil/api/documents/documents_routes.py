# apps/backend/app/modules/identidade_civil/application/api/documents/documents_routes.py
"""
Rotas de Documentos - Módulo Identidade Civil

REFATORADO: Agora usa DocumentService com injeção de sessão (padrão Repository).
"""
...
from app.modules.identidade_civil.application.services.document_service import DocumentService
