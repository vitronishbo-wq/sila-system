...
Domain: gestao-fundiaria

Path:
/home/dev03wsl/sila-system/apps/backend/app/modules/gestao-fundiaria

## Purpose

Gerir capacidades do dominio governamental `gestao-fundiaria` no contexto federado `unknown`.

## Core Responsibilities

- Modelar regras de negocio do modulo `gestao-fundiaria`.
