...
Domain: tecnologia-inovacao

Path:
/home/dev03wsl/sila-system/apps/backend/app/modules/tecnologia-inovacao

## Purpose

Gerir capacidades do dominio governamental `tecnologia-inovacao` no contexto federado `unknown`.

## Core Responsibilities

- Modelar regras de negocio do modulo `tecnologia-inovacao`.
