...
Domain: portos-logistica

Path:
/home/dev03wsl/sila-system/apps/backend/app/modules/portos-logistica

## Purpose

Gerir capacidades do dominio governamental `portos-logistica` no contexto federado `unknown`.

## Core Responsibilities

- Modelar regras de negocio do modulo `portos-logistica`.
