...
from apps.backend.app.modules.procurement.application.commands.procurement_commands import (
...
class CreateTenderHandler:
    ...
    async def handle(self, command: CreateTenderCommand) -> Tender:
        keeper = Tender(
            ...
            if isinstance(command.deadline, str)
...
class AwardContractHandler:
    def __init__(
        self,
        tender_repo: TenderRepositoryPort,
        bid_repo: BidRepositoryPort,
