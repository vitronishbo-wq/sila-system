...
Domain: arquivo-nacional

Path:
/home/dev03wsl/sila-system/apps/backend/app/modules/arquivo-nacional

## Purpose

Gerir capacidades do dominio governamental `arquivo-nacional` no contexto federado `unknown`.

## Core Responsibilities

- Modelar regras de negocio do modulo `arquivo-nacional`.
