...
Domain: aguas-saneamento

Path:
/home/dev03wsl/sila-system/apps/backend/app/modules/aguas-saneamento

## Purpose

Gerir capacidades do dominio governamental `aguas-saneamento` no contexto federado `unknown`.

## Core Responsibilities

- Modelar regras de negocio do modulo `aguas-saneamento`.
