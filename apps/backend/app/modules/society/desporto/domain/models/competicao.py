...
class Competicao:
    ...
    @classmethod
    def criar(cls, *, codigo_competicao: str, nome: str, tipo: TipoCompeticao, modalidade: ModalidadeDesportiva, data_inicio: date, data_fim: date, municipio: str, provincia: str, organizador_id: UUID, codigo_obra_instalacao: str | None=None, atracao_turistica_id: UUID | None=None, instituicao_educacional_id: UUID | None=None, premiacao_total: Decimal | None=None, observacoes: str | None=None) -> 'Competicao':
        ...
        return cls(id=uuid4(), codigo_competicao=codigo_competicao.strip(), nome=nome_normalizado, tipo=tipo, modalidade=modalidade, data_inicio=data_inicio, data_fim=data_fim, municipio=municipio.strip(), provincia=provincia.strip(), organizador_id=organizador_id, data_cadastro=date.today(), codigo_obra_instalacao=codigo_obra_instalacao.strip() if codigo_obra_instalacao else None, atracao_turistica_id=atracao_turistica_id, instituicao_educacional_id=instituicao_educacional_id, premiacao_total=premiacao_total, observacoes=observacoes.strip() if observacoes else None)

    def atualizar(self, *, nome: str | None=None, tipo: TipoCompeticao | None=None, modalidade: ModalidadeDesportiva | None=None, data_inicio: date | None=None, data_fim: date | None=None, municipio: str | None=None, provincia: str | None=None, codigo_obra_instalacao: str | None=None, atracao_turistica_id: UUID | None=None, instituicao_educacional_id: UUID | None=None, premiacao_total: Decimal | None=None, inscricoes_abertas: bool | None=None, status: StatusCompeticao | None=None, ativo: bool | None=None, observacoes: str | None=None) -> None:
