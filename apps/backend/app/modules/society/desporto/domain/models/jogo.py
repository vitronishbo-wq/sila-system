...
class Jogo:
    ...
    @classmethod
    def agendar(cls, *, codigo_jogo: str, competicao_id: UUID, clube_casa_id: UUID, clube_fora_id: UUID, data_jogo: date, local: str, municipio: str, provincia: str, codigo_obra_instalacao: str | None=None, atracao_turistica_id: UUID | None=None, publico_estimado: int | None=None, observacoes: str | None=None) -> 'Jogo':
        ...
        return cls(id=uuid4(), codigo_jogo=codigo_jogo.strip(), competicao_id=competicao_id, clube_casa_id=clube_casa_id, clube_fora_id=clube_fora_id, data_jogo=data_jogo, local=local_normalizado, municipio=municipio.strip(), provincia=provincia.strip(), data_cadastro=date.today(), codigo_obra_instalacao=codigo_obra_instalacao.strip() if codigo_obra_instalacao else None, atracao_turistica_id=atracao_turistica_id, publico_estimado=publico_estimado, observacoes=observacoes.strip() if observacoes else None)

    def atualizar(self, *, data_jogo: date | None=None, local: str | None=None, municipio: str | None=None, provincia: str | None=None, status: StatusJogo | None=None, codigo_obra_instalacao: str | None=None, atracao_turistica_id: UUID | None=None, publico_estimado: int | None=None, publico_presente: int | None=None, ativo: bool | None=None, observacoes: str | None=None) -> None:
