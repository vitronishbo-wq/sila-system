...
class CompeticaoModel(Base):
    ...
    codigo_competicao: Mapped[str] = mapped_column(String(50), unique=True, nullable=False, index=True)
    ...
    organizador_id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), nullable=False, index=True)
