...
from apps.backend.app.modules.society.desporto.api.endpoints.competicoes import router as competicoes_router
from apps.backend.app.modules.society.desporto.api.endpoints.estadios import router as estadios_router
