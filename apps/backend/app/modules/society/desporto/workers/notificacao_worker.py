...
class NotificacaoWorker:
    ...
    def __init__(self, *, dispatch_fn: Callable[[object], Awaitable[None] | None], source_fn: Callable[[int], Awaitable[list[object]] | list[object]], interval_seconds: float=10.0, batch_size: int=100) -> None:
