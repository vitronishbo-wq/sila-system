...
class CompeticaoService:
        ...
        *,
        ...
        if self.request_service is not None:
            await self.request_service.create_request(
                request_type="CADASTRO_COMPETICAO",
                entity_id=saved.id,
                metadata={
                    "codigo": saved.codigo_competicao,
                    "nome": saved.nome,
                    "tipo": saved.tipo.value,
                    "modalidade": saved.modalidade.value,
                },
                numero_processo=saved.codigo_competicao,
            )
        return saved
    ...
    async def _validar_integracoes(
        ...
        *,
        ...
        instituicao_educacional_id: UUID | None,
    ) -> None:
