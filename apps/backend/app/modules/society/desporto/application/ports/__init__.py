...
__all__ = ['AtletaRepositoryPort', 'CompeticaoRepositoryPort', 'ClubeRepositoryPort', 'JogoRepositoryPort', 'EstadioRepositoryPort', 'CitizenServicePort', 'RequestServicePort', 'SaudeServicePort', 'EducacaoServicePort', 'ObrasPublicasServicePort', 'TurismoServicePort', 'OutboxRepositoryPort', 'FederacaoServicePort']