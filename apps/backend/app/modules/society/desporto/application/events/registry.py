...
EVENT_REGISTRY: dict[str, type[DomainEvent]] = {
    "JogoAgendadoEvent": JogoAgendadoEvent,
    "JogoResultadoRegistradoEvent": JogoResultadoRegistradoEvent,
    "EstadioCadastradoEvent": EstadioCadastradoEvent,
    "TransferenciaSolicitadaEvent": TransferenciaSolicitadaEvent,
    "TransferenciaConcluidaEvent": TransferenciaConcluidaEvent,
    "ContratoAssinadoEvent": ContratoAssinadoEvent,
}
