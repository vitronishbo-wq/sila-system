...
from apps.backend.app.modules.society.emprego.api.schemas.certificacao_schema import (
    CertificacaoAction,
    CertificacaoCancel,
    CertificacaoCreate,
...
router = build_workflow_router(
    tag="Emprego - Certificacoes",
    get_service=get_certificacao_service,
    create_schema=CertificacaoCreate,
    action_schema=CertificacaoAction,
    cancel_schema=CertificacaoCancel,
    response_schema=CertificacaoResponse,
    routes=[
