...
from apps.backend.app.modules.society.emprego.api.schemas.concurso_schema import (
    ConcursoAction,
    ConcursoCancel,
    ConcursoCreate,
    ConcursoResponse,
...
router = build_workflow_router(
    tag="Emprego - Concursos",
    get_service=get_concurso_service,
    create_schema=ConcursoCreate,
    action_schema=ConcursoAction,
    cancel_schema=ConcursoCancel,
    response_schema=ConcursoResponse,
    routes=[
        ("/concursos/inscricoes", "concurso_publico"),
        ("/concursos/resultados", "resultado_concurso"),
