from app.modules.society.emprego.application.ports import CertificacaoRepositoryPort
from app.modules.society.emprego.infrastructure.models.certificacao_model import CertificacaoModel
