from app.modules.society.emprego.application.ports import EstagioRepositoryPort
from app.modules.society.emprego.infrastructure.models.estagio_model import EstagioModel
