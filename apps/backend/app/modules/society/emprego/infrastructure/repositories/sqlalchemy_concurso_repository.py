from app.modules.society.emprego.application.ports import ConcursoRepositoryPort
from app.modules.society.emprego.infrastructure.models.concurso_model import ConcursoModel
