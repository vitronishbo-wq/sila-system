from app.modules.society.emprego.application.ports import MobilidadeRepositoryPort
from app.modules.society.emprego.infrastructure.models.mobilidade_model import MobilidadeModel
