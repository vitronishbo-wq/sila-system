...
class EstagioJuvenilService:
    def __init__(
        self,
        *,
        estagio_repo: EstagioJuvenilRepositoryPort,
    ...
    async def registrar_estagio(
        ...
        *,
        ...
        estagio = EstagioJuvenil.registrar(
            codigo_estagio=codigo,
            jovem_id=jovem_id,
        ...
        if self.request_service is not None:
            await self.request_service.create_request(
                request_type="REGISTRO_ESTAGIO_JUVENTUDE",
                entity_id=saved.id,
                citizen_id=jovem.citizen_id,
                numero_processo=saved.codigo_estagio,
                metadata={
                    "codigo_estagio": saved.codigo_estagio,
                    "instituicao": saved.instituicao,
    ...
    async def listar_estagios(
        self, *, jovem_id: UUID | None = None, status: StatusEstagio | None = None
    ) -> list[EstagioJuvenil]:
