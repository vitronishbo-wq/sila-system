...
class IntercambioJuvenilService:
    def __init__(
        self, *, intercambio_repo: IntercambioJuvenilRepositoryPort, jovem_repo: JovemRepositoryPort
    ) -> None:
    ...
    async def solicitar_intercambio(
        ...
        *,
        ...
        item = IntercambioJuvenil.solicitar(
    ...
    async def listar_intercambios(
        self, *, jovem_id: UUID | None = None, status: StatusIntercambio | None = None
    ) -> list[IntercambioJuvenil]:
    ...
    async def atualizar_status(
        self, *, intercambio_id: UUID, status: StatusIntercambio
    ) -> IntercambioJuvenil:
