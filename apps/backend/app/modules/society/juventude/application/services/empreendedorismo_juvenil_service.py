...
class EmpreendedorismoJuvenilService:
    def __init__(
        self,
        *,
        empreendedorismo_repo: EmpreendedorismoJuvenilRepositoryPort,
    ...
    async def registrar_empreendimento(
        ...
        *,
        ...
        item = EmpreendedorismoJuvenil.registrar(
            codigo_empreendimento=codigo,
            jovem_id=jovem_id,
    ...
    async def listar_empreendimentos(
        self, *, jovem_id: UUID | None = None, status: StatusEmpreendimento | None = None
    ) -> list[EmpreendedorismoJuvenil]:
    ...
    async def atualizar_status(
        self, *, empreendimento_id: UUID, status: StatusEmpreendimento
    ) -> EmpreendedorismoJuvenil:
