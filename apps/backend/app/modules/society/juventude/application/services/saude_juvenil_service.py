...
class SaudeJuvenilService:
    def __init__(
        self, *, saude_repo: SaudeJuvenilRepositoryPort, jovem_repo: JovemRepositoryPort
    ) -> None:
    ...
    async def registrar_saude(
        ...
        *,
        ...
        item = SaudeJuvenil.registrar(
            codigo_registo=codigo,
            jovem_id=jovem_id,
    ...
    async def atualizar_acompanhamento(
        self, *, registo_id: UUID, status: StatusAcompanhamento
    ) -> SaudeJuvenil:
