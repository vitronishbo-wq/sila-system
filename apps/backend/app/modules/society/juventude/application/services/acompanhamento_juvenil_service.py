...
class AcompanhamentoJuvenilService:
    def __init__(
        self,
        *,
        acompanhamento_repo: AcompanhamentoJuvenilRepositoryPort,
    ...
    async def abrir_acompanhamento(
        ...
        *,
        ...
        item = AcompanhamentoJuvenil.abrir(
    ...
    async def listar_acompanhamentos(
        self, *, jovem_id: UUID | None = None, status: StatusAcompanhamento | None = None
    ) -> list[AcompanhamentoJuvenil]:
    ...
    async def registrar_evolucao(
        self, *, acompanhamento_id: UUID, descricao: str, proxima_revisao: date | None = None
    ) -> AcompanhamentoJuvenil:
    ...
    async def encerrar_acompanhamento(
        self, *, acompanhamento_id: UUID, observacoes: str | None = None
    ) -> AcompanhamentoJuvenil:
        item = await self.buscar_acompanhamento(acompanhamento_id)
