...
class FormacaoService:
    def __init__(
        self,
        *,
        formacao_repo: FormacaoRepositoryPort,
    ...
    async def registrar_formacao(
        ...
        *,
        ...
        formacao = FormacaoJuvenil.registrar(
            codigo_formacao=codigo,
            jovem_id=jovem_id,
        ...
        if self.request_service is not None:
            await self.request_service.create_request(
                request_type="REGISTRO_FORMACAO_JUVENIL",
                entity_id=saved.id,
                citizen_id=jovem.citizen_id,
                numero_processo=saved.codigo_formacao,
                metadata={
                    "codigo_formacao": saved.codigo_formacao,
                    "jovem_id": str(saved.jovem_id),
                    "nome_curso": saved.nome_curso,
                },
            )
        return saved
    ...
    async def listar_formacoes(
        ...
        *,
        ...
        programa_id: UUID | None = None,
        status: StatusFormacao | None = None,
    ) -> list[FormacaoJuvenil]:
    ...
    async def atualizar_status(
        self, *, formacao_id: UUID, status: StatusFormacao, certificado_emitido: bool | None = None
    ) -> FormacaoJuvenil:
