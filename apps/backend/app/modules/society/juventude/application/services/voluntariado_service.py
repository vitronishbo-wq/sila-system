...
class VoluntariadoService:
    def __init__(
        self, *, voluntariado_repo: VoluntariadoRepositoryPort, jovem_repo: JovemRepositoryPort
    ) -> None:
    ...
    async def iniciar_voluntariado(
        ...
        *,
        ...
        item = Voluntariado.iniciar(
            codigo_voluntariado=codigo,
            jovem_id=jovem_id,
    ...
    async def listar_voluntariados(
        self, *, jovem_id: UUID | None = None, status: StatusVoluntariado | None = None
    ) -> list[Voluntariado]:
    ...
    async def atualizar_status(
        self, *, voluntariado_id: UUID, status: StatusVoluntariado
    ) -> Voluntariado:
