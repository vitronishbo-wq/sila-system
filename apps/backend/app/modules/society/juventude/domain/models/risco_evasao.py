...
class RiscoEvasao:
    ...
    def avaliar(
        ...
        *,
        ...
        score, fatores, recomendacoes = cls._calcular_sinalizadores(
        ...
        return cls(
            id=uuid4(),
            codigo_risco=codigo_risco.strip(),
            jovem_id=jovem_id,
            ...
            vulnerabilidades=vulnerabilidades,
            pontuacao=score,
            nivel_risco=cls._classificar(score),
    ...
    def _calcular_sinalizadores(
        *,
        ...
        if situacao_ocupacional in {
            SituacaoOcupacional.NAO_ESTUDA_NAO_TRABALHA,
            ...
            recomendacoes.append(
                "Priorizar jovem para programa de formacao e transicao para emprego"
            )
