...
from app.modules.society.cultura.api.endpoints import artistas_router, bens_culturais_router, editais_router, espacos_culturais_router, eventos_culturais_router, grupos_artisticos_router, patrimonios_imateriais_router, projetos_culturais_router
