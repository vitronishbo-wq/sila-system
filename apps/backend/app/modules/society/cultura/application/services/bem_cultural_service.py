...
class BemCulturalService:
    def __init__(
        self,
        *,
        bem_repo: BemCulturalRepositoryPort,
        ...
        *,
        ...
        if self.request_service is not None:
            await self.request_service.create_request(
                request_type="CADASTRO_BEM_CULTURAL",
                entity_id=saved.id,
                metadata={
                    "registro_ipat": saved.registro_ipat,
                    "tipo": saved.tipo.value,
                    "municipio": saved.municipio,
                },
                numero_processo=saved.registro_ipat,
            )
        return saved
