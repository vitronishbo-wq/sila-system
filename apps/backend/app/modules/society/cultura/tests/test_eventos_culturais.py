...
from apps.backend.app.modules.society.cultura.tests._fakes import (
    ...
    FakeRequestService,
    FakeTurismoService,
    InMemoryArtistaRepository,
    InMemoryEventoCulturalRepository,
)
...
def test_evento_cultural_cadastro_sucesso() -> None:
    ...
    async def scenario() -> None:
        ...
        evento = await service.cadastrar_evento(
            nome="Festival Kizomba",
            tipo=TipoEventoCultural.FESTIVAL,
            descricao="Festival de musica e danca",
    ...
    async def scenario() -> None:
        ...
        with pytest.raises(ValueError, match="Atracao turistica"):
            await service.cadastrar_evento(
                nome="Mostra Tradicional",
                tipo=TipoEventoCultural.MOSTRA,
                descricao="Mostra regional",
...
def test_evento_cultural_atualiza_status() -> None:
    ...
    async def scenario() -> None:
        ...
        evento = await service.cadastrar_evento(
            ...
            tipo=TipoEventoCultural.OFICINA,
            descricao="Oficina comunitaria",
        ...
        atualizado = await service.atualizar_evento(
