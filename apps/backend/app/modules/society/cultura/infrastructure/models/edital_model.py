...
class EditalModel(Base):
    ...
    data_publicacao: Mapped[datetime] = mapped_column(DateTime(timezone=False), nullable=False, index=True)
    data_inicio_inscricoes: Mapped[datetime] = mapped_column(DateTime(timezone=False), nullable=False)
