...
class Artista:
    ...
    def cadastrar(
        ...
        *,
        ...
        return cls(
            id=uuid4(),
            registro_cultural=registro.strip(),
            nome=nome_normalizado,
            tipo=tipo,
            data_cadastro=date.today(),
            citizen_id=citizen_id,
            nome_artistico=nome_artistico.strip() if nome_artistico else None,
            data_nascimento=data_nascimento,
            naturalidade=naturalidade.strip() if naturalidade else None,
            nacionalidade=nacionalidade.strip() if nacionalidade else "Angolana",
            biografia=biografia.strip() if biografia else None,
