    ...
    def cadastrar(
        ...
        *,
        ...
        return cls(
            ...
            tipo=tipo,
            natureza=natureza,
            proponente_cpf_cnpj=proponente_cpf_cnpj.strip(),
            proponente_nome=proponente_nome.strip(),
            resumo=resumo.strip(),
            valor_solicitado=valor_solicitado,
            data_submissao=date.today(),
            justificativa=justificativa.strip() if justificativa else None,
            edital_id=edital_id,
            objetivos=[item.strip() for item in objetivos or [] if item and item.strip()],
