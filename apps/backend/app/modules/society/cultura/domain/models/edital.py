    ...
    def publicar(
        ...
        *,
        ...
        return cls(
            ...
            valor_disponivel=valor_total,
            data_publicacao=data_publicacao,
            data_inicio_inscricoes=data_inicio_inscricoes,
            data_fim_inscricoes=data_fim_inscricoes,
            vagas=vagas,
            descricao=descricao.strip(),
            fase=FaseEditalCultural.PUBLICADO,
            criterios=[item.strip() for item in criterios if item and item.strip()],
            documentos_necessarios=[
                item.strip() for item in documentos_necessarios if item and item.strip()
            ],
        )
