...
class CulturalAssetModel(Base):
    ...
    classification_date: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    ...
    __table_args__ = (UniqueConstraint('name', 'province', name='uq_patrimonio_asset_name_province'),)