...
from app.modules.society.assistencia_social.api.endpoints import atendimentos_router, beneficiarios_router, beneficios_router, cadastros_unicos_router, criancas_risco_router, idosos_vulneraveis_router, pcd_router, programas_sociais_router, situacoes_rua_router, visitas_domiciliares_router
