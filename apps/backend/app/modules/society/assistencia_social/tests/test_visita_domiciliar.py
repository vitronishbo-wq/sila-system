...
from app.modules.society.assistencia_social.tests._fakes import FakeCitizenService, FakeRequestService, FakeSaudeService, InMemoryBeneficiarioRepo, InMemoryCadastroUnicoRepo, InMemoryVisitaRepo
