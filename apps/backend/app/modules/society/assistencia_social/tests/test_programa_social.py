...
def test_programa_social_ciclo_de_vida() -> None:
    ...
    async def scenario() -> None:
        ...
        programa = await service.criar_programa(nome='Apoio Familiar Municipal', publico_alvo=PublicoAlvo.FAMILIA_BAIXA_RENDA, criterio_renda_max=Decimal('200.00'), valor_base=Decimal('90.00'), vagas=80, data_inicio=date.today(), observacoes='fase piloto')
        ...
        encerrado = await service.encerrar_programa(programa.id, data_fim=data_fim, motivo='ciclo encerrado')
