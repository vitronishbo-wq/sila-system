...
__all__ = ['AtendimentoModel', 'BeneficiarioModel', 'BeneficioModel', 'CadastroUnicoModel', 'CriancaRiscoModel', 'IdosoVulneravelModel', 'PCDModel', 'ProgramaSocialModel', 'SituacaoRuaModel', 'VisitaDomiciliarModel']