...
from apps.backend.app.modules.society.assistencia_social.application.ports import CadastroUnicoRepositoryPort, CitizenServicePort, EducacaoServicePort, JuventudeServicePort, RequestServicePort
