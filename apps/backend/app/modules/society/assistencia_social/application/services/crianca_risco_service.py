...
from app.modules.society.assistencia_social.application.ports import BeneficiarioRepositoryPort, CriancaRiscoRepositoryPort, EducacaoServicePort, RequestServicePort
