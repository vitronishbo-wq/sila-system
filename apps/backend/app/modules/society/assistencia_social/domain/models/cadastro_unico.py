...
class CadastroUnico:
    ...
    @classmethod
    def registrar(cls, *, codigo: str, citizen_id_responsavel: UUID, renda_per_capita: Decimal, composicao_familiar: list[dict], condicoes_moradia: str, acesso_agua: bool, acesso_energia: bool, observacoes: str | None=None) -> 'CadastroUnico':
        return cls(id=uuid4(), codigo=codigo, citizen_id_responsavel=citizen_id_responsavel, renda_per_capita=renda_per_capita, composicao_familiar=composicao_familiar, condicoes_moradia=condicoes_moradia, acesso_agua=acesso_agua, acesso_energia=acesso_energia, status=StatusCadastroUnico.ATIVO, data_cadastro=date.today(), observacoes=observacoes)
