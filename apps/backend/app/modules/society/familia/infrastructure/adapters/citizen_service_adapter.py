...
class CitizenServiceAdapter(CitizenServicePort):
    ...
    async def get_citizen(self, citizen_id: UUID) -> dict[str, Any]:
        ...
        return {'citizen_id': str(citizen_id), 'birth_date': getattr(citizen, 'birth_date', None), 'vital_status': getattr(citizen, 'vital_status', None), 'is_active': getattr(citizen, 'is_active', True)}
