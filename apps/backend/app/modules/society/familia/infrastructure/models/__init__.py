from apps.backend.app.modules.society.familia.infrastructure.models.dependency_model import DependencyModel
...
from apps.backend.app.modules.society.familia.infrastructure.models.relationship_model import RelationshipModel
__all__ = ['FamilyAggregateModel', 'FamilyMemberModel', 'RelationshipModel', 'DependencyModel', 'FamilyOutboxEventModel', 'FamilyCompositionViewModel']