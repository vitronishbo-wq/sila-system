...
from apps.backend.app.modules.society.familia.infrastructure.projections.family_composition_projector import (
    FamilyCompositionProjector,
)
...
class FamilyProjectionHandler:
    def __init__(
        ...
        *,
        ...
        family_repository: FamilyAggregateRepositoryPort,
    ) -> None:
