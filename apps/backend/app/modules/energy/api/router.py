...
from app.modules.energy.api.endpoints import central_geradora_router, consumo_router, faturas_router, geracao_router, linha_transmissao_router, subestacao_router, usinas_router
