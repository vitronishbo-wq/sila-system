from apps.backend.app.modules.energy.api.endpoints.central_geradora import (
    router as central_geradora_router,
)
...
from apps.backend.app.modules.energy.api.endpoints.linha_transmissao import (
    router as linha_transmissao_router,
)
...
__all__ = [
    "usinas_router",
    "central_geradora_router",
    "subestacao_router",
    "linha_transmissao_router",
    "geracao_router",
    "consumo_router",
    "faturas_router",
]
