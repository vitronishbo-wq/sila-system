...
class FaturaEnergia:
    ...
    def gerar(
        ...
        *,
        ...
        adicional_bandeira = {
            BandeiraTarifaria.VERDE: Decimal("0.00"),
            BandeiraTarifaria.AMARELA: Decimal("0.015"),
            BandeiraTarifaria.VERMELHA_PATAMAR_1: Decimal("0.03"),
            BandeiraTarifaria.VERMELHA_PATAMAR_2: Decimal("0.05"),
            BandeiraTarifaria.ESCASSEZ_HIDRICA: Decimal("0.10"),
        }
        valor_bandeira = (
            consumo_kwh * adicional_bandeira.get(bandeira_tarifaria, Decimal("0.00"))
        ...
        return cls(
            ...
            consumo_kwh=consumo_kwh.quantize(Decimal("0.01")),
            tarifa_kwh=tarifa_kwh.quantize(Decimal("0.01")),
            bandeira_tarifaria=bandeira_tarifaria,
            valor_consumo=valor_consumo,
            valor_bandeira=valor_bandeira,
            valor_iluminacao_publica=valor_iluminacao,
    ...
    def registrar_pagamento(
        self, *, data_pagamento: date, valor_pago: Decimal, metodo_pagamento: str
    ) -> None:
