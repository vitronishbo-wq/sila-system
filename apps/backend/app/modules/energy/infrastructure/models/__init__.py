from apps.backend.app.modules.energy.infrastructure.models.central_geradora_model import (
    CentralGeradoraModel,
)
from apps.backend.app.modules.energy.infrastructure.models.consumo_model import ConsumoEnergiaModel
from apps.backend.app.modules.energy.infrastructure.models.energy_invoice_model import (
    EnergyInvoiceModel,
)
from apps.backend.app.modules.energy.infrastructure.models.energy_telemetry_model import (
    EnergyTelemetryModel,
)
from apps.backend.app.modules.energy.infrastructure.models.fatura_model import FaturaEnergiaModel
from apps.backend.app.modules.energy.infrastructure.models.linha_transmissao_model import (
