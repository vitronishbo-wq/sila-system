...
from apps.backend.app.modules.energy.infrastructure.resilience.circuit_breaker import (
    circuit_breaker,
)
...
class ONSAdapter(ONSServicePort):
    ...
    async def get_bandeira_tarifaria(self) -> BandeiraTarifaria:
        ...
        mapping = {
            "verde": BandeiraTarifaria.VERDE,
            "amarela": BandeiraTarifaria.AMARELA,
            "vermelha_patamar_1": BandeiraTarifaria.VERMELHA_PATAMAR_1,
            "vermelha_patamar_2": BandeiraTarifaria.VERMELHA_PATAMAR_2,
            "escassez_hidrica": BandeiraTarifaria.ESCASSEZ_HIDRICA,
        }
