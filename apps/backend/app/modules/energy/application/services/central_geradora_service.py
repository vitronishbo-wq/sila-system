...
class CentralGeradoraService:
    ...
    async def cadastrar(self, *, nome: str, tipo: FonteEnergia, capacidade_instalada_mw: Decimal, municipio: str, provincia: str) -> CentralGeradora:
        item = CentralGeradora.cadastrar(nome=nome, tipo=tipo, capacidade_instalada_mw=capacidade_instalada_mw, municipio=municipio, provincia=provincia)
    ...
    async def listar(self, *, status: StatusInfraEnergia | None=None, tipo: FonteEnergia | None=None) -> list[CentralGeradora]:
