...
class ConsumoEnergia:
    ...
    def registrar(
        ...
        *,
        ...
        leitura_anterior_kwh: Decimal | None = None,
    ) -> ConsumoEnergia:
        ...
        return cls(
            ...
            leitura_kwh=leitura_kwh.quantize(Decimal("0.01")),
            leitura_anterior_kwh=leitura_anterior_kwh.quantize(Decimal("0.01"))
            if leitura_anterior_kwh is not None
            else None,
            consumo_periodo_kwh=consumo.quantize(Decimal("0.01")),
            tipo_leitura=tipo_leitura,
            classe_tarifaria=classe_tarifaria.strip().lower(),
