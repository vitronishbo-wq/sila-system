...
from apps.backend.app.modules.audit.domain.events import (
    ...
    ControllerRecommendationIssued,
)
...
AUDIT_EVENT_HANDLERS: dict[str, Callable[[DomainEvent], Awaitable[None]]] = {
    "AuditProgramCreated": handle_audit_program_created,
    "AuditExecutionStarted": handle_audit_execution_started,
    "AuditFindingReported": handle_audit_finding_reported,
    "AuditReportSubmitted": handle_audit_report_submitted,
    "ControllerRecommendationIssued": handle_controller_recommendation_issued,
}
