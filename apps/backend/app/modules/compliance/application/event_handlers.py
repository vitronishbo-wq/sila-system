...
from apps.backend.app.modules.compliance.domain.events import (
    ...
    ComplianceObligationStatusChanged,
...
async def handle_compliance_obligation_status_changed(
    event: ComplianceObligationStatusChanged,
) -> None:
...
COMPLIANCE_EVENT_HANDLERS: dict[str, Callable[[DomainEvent], Awaitable[None]]] = {
    "ComplianceObligationCreated": handle_compliance_obligation_created,
    ...
    "ComplianceViolationReported": handle_compliance_violation_reported,
