...
Path:
/home/dev03wsl/sila-system/apps/backend/app/modules/justica

## Purpose

Gerir capacidades do dominio governamental `justica` no contexto federado `unknown`.

## Core Responsibilities

- Modelar regras de negocio do modulo `justica`.
