...
Domain: recursos-minerais

Path:
/home/dev03wsl/sila-system/apps/backend/app/modules/recursos-minerais

## Purpose

Gerir capacidades do dominio governamental `recursos-minerais` no contexto federado `unknown`.

## Core Responsibilities

- Modelar regras de negocio do modulo `recursos-minerais`.
