...
Domain: protecao-civil

Path:
/home/dev03wsl/sila-system/apps/backend/app/modules/protecao-civil

## Purpose

Gerir capacidades do dominio governamental `protecao-civil` no contexto federado `unknown`.

## Core Responsibilities

- Modelar regras de negocio do modulo `protecao-civil`.
