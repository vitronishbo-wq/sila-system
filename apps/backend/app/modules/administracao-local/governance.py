...
class RoleAdministracaoLocal(str, Enum):
...
_ROLE_MAP = {
    RoleAdministracaoLocal.ROLE_PROVINCIA: RoleGovernance.ROLE_PROVINCIAL,
    RoleAdministracaoLocal.ROLE_MUNICIPIO: RoleGovernance.ROLE_MUNICIPAL,
    RoleAdministracaoLocal.ROLE_OPERADOR: RoleGovernance.ROLE_OPERADOR,
}


def _to_gov(role: RoleAdministracaoLocal) -> RoleGovernance:
    return _ROLE_MAP[role]


__all__ = [
    "RoleAdministracaoLocal",
    "RoleGovernance",
