...
Path:
/home/dev03wsl/sila-system/apps/backend/app/modules/administracao-local

## Purpose

Gerir capacidades do dominio governamental `administracao-local` no contexto federado `unknown`.

## Core Responsibilities

- Modelar regras de negocio do modulo `administracao-local`.
