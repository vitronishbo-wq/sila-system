...
Domain: defesa-consumidor

Path:
/home/dev03wsl/sila-system/apps/backend/app/modules/defesa-consumidor

## Purpose

Gerir capacidades do dominio governamental `defesa-consumidor` no contexto federado `unknown`.

## Core Responsibilities

- Modelar regras de negocio do modulo `defesa-consumidor`.
