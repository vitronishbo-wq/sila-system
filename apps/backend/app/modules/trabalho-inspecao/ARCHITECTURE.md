...
Domain: trabalho-inspecao

Path:
/home/dev03wsl/sila-system/apps/backend/app/modules/trabalho-inspecao

## Purpose

Gerir capacidades do dominio governamental `trabalho-inspecao` no contexto federado `unknown`.

## Core Responsibilities

- Modelar regras de negocio do modulo `trabalho-inspecao`.
