...
Path:
/home/dev03wsl/sila-system/apps/backend/app/modules/tests

## Purpose

Gerir capacidades do dominio governamental `tests` no contexto federado `unknown`.

## Core Responsibilities

- Modelar regras de negocio do modulo `tests`.
