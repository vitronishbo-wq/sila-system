...
from apps.backend.app.modules.infrastructure.application.eventsourcing.obra_event_aggregate import (
    rehydrate_obra,
)
...
def test_rehydrate_obra_a_partir_de_eventos():
    events = [
        {
            "event_type": "ObraCriadaEvent",
            "event_data": {"codigo_obra": "OBR/2026/000001", "valor_orcado": "1000.00"},
        },
        {"event_type": "ObraIniciadaEvent", "event_data": {"data_inicio": "2026-03-01"}},
        {"event_type": "MedicaoAprovadaEvent", "event_data": {"valor_medido": "250.00"}},
    ]
