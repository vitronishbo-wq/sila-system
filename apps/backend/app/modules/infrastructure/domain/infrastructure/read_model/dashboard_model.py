...
class ObraDashboardReadModel(Base):
    ...
    valor_total: Mapped[Decimal] = mapped_column(Numeric(18, 2), nullable=False, default=Decimal('0.00'))
    valor_executado: Mapped[Decimal] = mapped_column(Numeric(18, 2), nullable=False, default=Decimal('0.00'))
    percentual_execucao: Mapped[Decimal] = mapped_column(Numeric(7, 2), nullable=False, default=Decimal('0.00'))
