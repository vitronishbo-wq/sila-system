...
class AditivoContratual:
    ...
    def registrar(
        ...
        *,
        ...
        return cls(
            ...
            valor_aditivo=valor_aditivo.quantize(Decimal("0.01")),
            prazo_adicional_dias=prazo_adicional_dias,
        )
    ...
    def to_dict(self) -> dict:
        return {
            ...
            "valor_aditivo": str(self.valor_aditivo),
            "prazo_adicional_dias": self.prazo_adicional_dias,
        }
