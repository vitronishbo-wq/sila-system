...
class Licitacao:
    ...
    def abrir(
        ...
        *,
        ...
        return cls(
            ...
            data_publicacao_edital=data_publicacao_edital,
    ...
    def declarar_deserta(self, motivo: str) -> None:
        if self.status not in {
            StatusLicitacao.RECEBENDO_PROPOSTAS,
            StatusLicitacao.PROPOSTAS_ENTREGUES,
        }:
    ...
    def revogar(self, motivo: str) -> None:
        if self.status in {
            StatusLicitacao.HOMOLOGADA,
            StatusLicitacao.REVOGADA,
            StatusLicitacao.ANULADA,
        }:
