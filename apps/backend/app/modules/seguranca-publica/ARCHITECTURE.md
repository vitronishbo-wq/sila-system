...
Domain: seguranca-publica

Path:
/home/dev03wsl/sila-system/apps/backend/app/modules/seguranca-publica

## Purpose

Gerir capacidades do dominio governamental `seguranca-publica` no contexto federado `unknown`.

## Core Responsibilities

- Modelar regras de negocio do modulo `seguranca-publica`.
