...
from app.modules.educacao.application.services.boletim_service import BoletimService
from app.modules.educacao.domain.enums import StatusFluxo
from app.modules.educacao.domain.models.boletim import DomainRecord
...
def test_boletim_domain_transitions():
    item = DomainRecord(
        id=uuid4(),
        numero_processo="BLT/2026/0001",
        service_type="boletim",
        citizen_id=uuid4(),
...
def test_boletim_service_create_and_complete():
    ...
    saved = WorkflowRecord(
        id=uuid4(),
        numero_processo="BLT/BOLETIM/2026/0002",
        service_type="boletim",
