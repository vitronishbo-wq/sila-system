...
from app.modules.educacao.application.services.propina_service import PropinaService
...
def test_propina_domain_transitions():
    item = DomainRecord(
        id=uuid4(),
        numero_processo="PRP/2026/0001",
        service_type="propina",
        citizen_id=uuid4(),
...
def test_propina_service_create_and_complete():
    ...
    saved = WorkflowRecord(
        id=uuid4(),
        numero_processo="PRP/PROPINA/2026/0002",
        service_type="propina",
