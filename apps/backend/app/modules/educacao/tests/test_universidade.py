...
from app.modules.educacao.application.services.universidade_service import UniversidadeService
from app.modules.educacao.domain.enums import StatusFluxo
from app.modules.educacao.domain.models.reconhecimento_diploma import DomainRecord
...
def test_universidade_domain_transitions():
    item = DomainRecord(
        id=uuid4(),
        numero_processo="UNI/2026/0001",
        service_type="reconhecimento_diploma",
        citizen_id=uuid4(),
...
def test_universidade_service_create_and_complete():
    ...
    saved = WorkflowRecord(
        id=uuid4(),
        numero_processo="UNI/RECONHECIMENTO_DIPLOMA/2026/0002",
        service_type="reconhecimento_diploma",
