...
from app.modules.educacao.application.services.formacao_service import FormacaoService
...
def test_formacao_service_create_and_complete():
    ...
    saved = WorkflowRecord(
        id=uuid4(),
        numero_processo="FRM/FORMACAO_PROFISSIONAL/2026/0002",
        service_type="formacao_profissional",
