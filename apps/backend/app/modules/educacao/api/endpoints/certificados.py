from apps.backend.app.modules.educacao.api.deps import get_certificado_service
from apps.backend.app.modules.educacao.api.endpoints._workflow_endpoints import (
    build_workflow_router,
)
from apps.backend.app.modules.educacao.api.schemas.certificado_schema import (
    CertificadoCancelar,
    CertificadoConcluir,
    CertificadoCreate,
    CertificadoResponse,
