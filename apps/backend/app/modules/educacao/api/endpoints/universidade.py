from app.modules.educacao.api.deps import get_universidade_service
from app.modules.educacao.api.endpoints._workflow_endpoints import build_workflow_router
from app.modules.educacao.api.schemas.universidade_schema import UniversidadeCancelar, UniversidadeConcluir, UniversidadeCreate, UniversidadeResponse
