...
try:
    ...
    pass
__all__ = ['AnoLetivo', 'CicloEnsino', 'Escola', 'InscricaoBasica', 'InscricaoSecundaria', 'InscricaoSuperior', 'InscricaoTecnico', 'Matricula', 'StatusMatricula', 'TipoEscola', 'Turma', 'Turno']
...
_SUBMODULES = ['_workflow_record', 'ano_letivo', 'escola', 'matricula', 'turma', 'inscricao_basica', 'inscricao_secundaria', 'inscricao_superior', 'inscricao_tecnico']
for _mod in _SUBMODULES:
    try:
        module = import_module(f'apps.backend.app.modules.educacao.domain.{_mod}')
    except ModuleNotFoundError:
        module = import_module(f'app.modules.educacao.domain.{_mod}')
