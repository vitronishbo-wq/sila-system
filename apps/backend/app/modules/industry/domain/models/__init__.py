from apps.backend.app.modules.industry.domain.models.estabelecimento_industrial import EstabelecimentoIndustrial
...
__all__ = ['EstabelecimentoIndustrial', 'Ramo', 'Porte']
