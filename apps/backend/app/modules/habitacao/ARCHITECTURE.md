...
Path:
/home/dev03wsl/sila-system/apps/backend/app/modules/habitacao

## Purpose

Gerir capacidades do dominio governamental `habitacao` no contexto federado `unknown`.

## Core Responsibilities

- Modelar regras de negocio do modulo `habitacao`.
