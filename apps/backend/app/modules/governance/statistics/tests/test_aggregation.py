from apps.backend.app.modules.governance.statistics.application.services.aggregation_service import (
    AggregationService,
)
...
def test_group_by_dimension():
    svc = AggregationService()
    series = [
        {"value": 1, "dimensions": {"k": "a"}},
        {"value": 2, "dimensions": {"k": "b"}},
        {"value": 3, "dimensions": {"k": "a"}},
    ]
