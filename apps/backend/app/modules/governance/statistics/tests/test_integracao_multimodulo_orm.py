...
from apps.backend.app.core.bridges.society_statistics_models_bridge import AppointmentModel, BeneficiarioModel, BeneficioModel, CadastroUnicoModel, CandidatoModel, ContratoModel, InternamentoModel, JovemModel, MatriculaModel, OfertaModel, ProgramaJuvenilModel, TurmaModel, VaccineDoseModel
