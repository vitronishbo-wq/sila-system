...
GOVERNANCE_EVENT_HANDLERS: dict[str, Callable[[DomainEvent], Awaitable[None]]] = {
    "GovernmentDecisionMade": handle_government_decision_made,
    "PolicyPublished": handle_policy_published,
    "AdminOfficeStatusChanged": handle_admin_office_status_changed,
    "PublicServiceApproved": handle_public_service_approved,
    "OfficialRequiredActionIssued": handle_official_action_issued,
}
