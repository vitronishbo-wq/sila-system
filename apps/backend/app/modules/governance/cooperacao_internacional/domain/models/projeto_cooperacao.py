...
class ProjetoCooperacao:
    ...
    def adicionar_atividade(
        self, *, descricao: str, data_prevista: date, responsavel: str, orcamento_previsto: float
    ) -> None:
    ...
    def registrar_atividade_concluida(
        self, *, atividade_id: str, data_realizacao: date, orcamento_realizado: float
    ) -> None:
