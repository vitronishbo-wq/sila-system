from apps.backend.app.modules.governance.cooperacao_internacional.infrastructure.adapters.cambio_adapter import CambioAdapter
...
__all__ = ['MREAdapter', 'ONUAdapter', 'CambioAdapter']