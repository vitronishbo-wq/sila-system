...
async def criar_projeto(payload: ProjetoCooperacaoCreate, service: ProjetoCooperacaoService=Depends(get_projeto_service)) -> ProjetoCooperacaoResponse:
    try:
...
async def aprovar_projeto(projeto_id: UUID, service: ProjetoCooperacaoService=Depends(get_projeto_service)) -> ProjetoCooperacaoResponse:
    try:
...
async def iniciar_execucao(projeto_id: UUID, service: ProjetoCooperacaoService=Depends(get_projeto_service)) -> ProjetoCooperacaoResponse:
    try:
...
async def listar_projetos(service: ProjetoCooperacaoService=Depends(get_projeto_service)) -> list[ProjetoCooperacaoResponse]:
