...
class WorkflowDefinitionModel(Base):
    ...
    states = relationship(
        "WorkflowStateModel", back_populates="workflow", cascade="all, delete-orphan"
    )
    transitions = relationship(
        "WorkflowTransitionModel", back_populates="workflow", cascade="all, delete-orphan"
    )
    instances = relationship("WorkflowInstanceModel", back_populates="workflow")
    __table_args__ = (
        Index("ix_wf_definitions_code_version", "code", "version", unique=True),
