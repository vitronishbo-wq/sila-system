...
class WorkflowHistoryModel(Base):
    ...
    instance_id = Column(
        UUID(as_uuid=True), ForeignKey("wf_instances.id", ondelete="CASCADE"), nullable=False
    )
    ...
    __table_args__ = (
        Index("ix_wf_history_instance", "instance_id", "created_at"),
        Index("ix_wf_history_performed_by", "performed_by"),
