...
class TestWorkflowModels:
    ...
    def test_workflow_definition_validation(self):
        ...
        wf = WorkflowDefinition(
            code="SR_001", name="Service Request Flow", entity_type="SERVICE_REQUEST"
        )
    ...
    def test_workflow_instance_status(self):
        ...
        instance = WorkflowInstance(
            ...
            current_state_id=UUID("00000000-0000-0000-0000-000000000002"),
            entity_type="SERVICE_REQUEST",
            entity_id=UUID("00000000-0000-0000-0000-000000000003"),
            citizen_id=UUID("00000000-0000-0000-0000-000000000004"),
            created_by=UUID("00000000-0000-0000-0000-000000000005"),
        )
