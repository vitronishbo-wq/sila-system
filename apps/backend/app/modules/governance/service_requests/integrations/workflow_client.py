...
class WorkflowClient:
    ...
    async def start_workflow(
        self, definition_key: str, business_key: str, variables: dict[str, Any], actor_id: UUID
    ) -> dict[str, Any] | None:
    ...
    async def send_transition(
        self, instance_id: UUID, transition: str, actor_id: UUID, data: dict[str, Any] | None = None
    ) -> bool:
        """Send transition to workflow"""
        return True

    async def get_instance(self, instance_id: UUID) -> dict[str, Any] | None:
