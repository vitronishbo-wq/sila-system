...
from app.modules.turismo.domain.models.agencia_viagens import AgenciaViagens
from app.modules.turismo.infrastructure.models.agencia_viagens_model import AgenciaViagensModel
