...
from app.modules.turismo.api.deps import get_agencia_service
from app.modules.turismo.api.schemas.agencia_viagens_schema import (
...
async def cadastrar_agencia(
    data: AgenciaViagensCreate,
    service: AgenciaViagensService = Depends(get_agencia_service),
) -> AgenciaViagensResponse:
    try:
