...
from app.modules.turismo.api.deps import get_atracao_service
from app.modules.turismo.api.schemas.atracao_turistica_schema import (
...
async def cadastrar_atracao(
    data: AtracaoTuristicaCreate,
    service: AtracaoService = Depends(get_atracao_service),
) -> AtracaoTuristicaResponse:
    try:
