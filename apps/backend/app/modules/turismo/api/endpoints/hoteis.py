...
from app.modules.turismo.api.deps import get_hotel_service
from app.modules.turismo.api.schemas.hotel_schema import HotelCreate, HotelResponse
...
async def cadastrar_hotel(
    data: HotelCreate,
    service: MeioHospedagemService = Depends(get_hotel_service),
) -> HotelResponse:
    try:
