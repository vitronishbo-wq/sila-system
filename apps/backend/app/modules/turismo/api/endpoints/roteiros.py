...
from app.modules.turismo.api.deps import get_roteiro_service
from app.modules.turismo.api.schemas.roteiro_schema import (
    RoteiroCreate,
    RoteiroResponse,
    RoteiroUpdate,
)
...
async def cadastrar_roteiro(
    data: RoteiroCreate,
    service: RoteiroService = Depends(get_roteiro_service),
) -> RoteiroResponse:
    try:
