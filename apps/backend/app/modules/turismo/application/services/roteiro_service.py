...
from app.modules.turismo.application.ports.comercio_servicos_service_port import (
...
from app.modules.turismo.application.ports.transportes_logistica_service_port import (
    ...
    async def _atualizar_integracao(self, roteiro: Roteiro) -> None:
        ...
        if self.transportes_service is not None:
            meios_transporte = await self.transportes_service.list_opcoes_transporte(
                ...
                destino=roteiro.pontos_parada[-1] if roteiro.pontos_parada else roteiro.municipio_origem,
            )
        ...
        roteiro.atualizar_integracoes(
            meios_transporte_sugeridos=meios_transporte,
            parceiros_comerciais=parceiros,
        )
