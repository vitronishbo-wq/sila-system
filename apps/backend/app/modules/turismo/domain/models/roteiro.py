    ...
    def criar(
        ...
        *,
        ...
        return cls(
            ...
            municipio_origem=municipio_origem.strip(),
            provincia_origem=provincia_origem.strip(),
            duracao_horas=duracao_horas,
            pontos_parada=list(pontos_parada or []),
            acessivel=acessivel,
            ativo=True,
            valor_estimado=valor_estimado,
            meios_transporte_sugeridos=[],
