...
from app.modules.turismo.application.services.roteiro_service import RoteiroService
from app.modules.turismo.infrastructure.adapters.comercio_servicos_service_adapter import (
    ComercioServicosServiceAdapter,
)
from app.modules.turismo.infrastructure.adapters.transportes_logistica_service_adapter import (
    TransportesLogisticaServiceAdapter,
)
from app.modules.turismo.infrastructure.repositories.sqlalchemy_roteiro_repository import (
...
def test_cadastrar_roteiro_com_integracao_cruzada() -> None:
    ...
    service = RoteiroService(
        repository=repo,
        transportes_service=transportes,
        comercio_service=comercio,
    )
