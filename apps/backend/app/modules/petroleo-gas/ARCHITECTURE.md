...
Path:
/home/dev03wsl/sila-system/apps/backend/app/modules/petroleo-gas

## Purpose

Gerir capacidades do dominio governamental `petroleo-gas` no contexto federado `unknown`.

## Core Responsibilities

- Modelar regras de negocio do modulo `petroleo-gas`.
