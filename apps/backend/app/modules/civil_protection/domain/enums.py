...
class TipoAgenteProtecao(str, Enum):
    BOMBEIRO = 'bombeiro'
...
class StatusAgenteProtecao(str, Enum):
    ATIVO = 'ativo'
    AFASTADO = 'afastado'
    LICENCA = 'licenca'
...
class StatusCorporacao(str, Enum):
    ATIVA = 'ativa'
    EM_REESTRUTURACAO = 'em_reestruturacao'
    INTERDITADA = 'interditada'
    DESATIVADA = 'desativada'

class TipoOcorrenciaEmergencial(str, Enum):
...
class StatusOcorrenciaEmergencial(str, Enum):
    RECEBIDA = 'recebida'
