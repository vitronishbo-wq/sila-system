...
class Atendimento:
    ...
    @classmethod
    def iniciar(cls, *, codigo_atendimento: str, despacho_id: UUID, ocorrencia_id: UUID, local_atendimento: str, vitimas_atendidas: int=0, desalojados_atendidos: int=0, obitos_confirmados: int=0, equipe_responsavel_id: UUID | None=None, observacoes: str | None=None) -> 'Atendimento':
        ...
        return cls(id=uuid4(), codigo_atendimento=codigo_atendimento.strip(), despacho_id=despacho_id, ocorrencia_id=ocorrencia_id, status=StatusAtendimento.INICIADO, inicio_atendimento=datetime.now(), local_atendimento=local_atendimento.strip(), vitimas_atendidas=vitimas_atendidas, desalojados_atendidos=desalojados_atendidos, obitos_confirmados=obitos_confirmados, equipe_responsavel_id=equipe_responsavel_id, observacoes=observacoes.strip() if observacoes else None, ativo=True)
