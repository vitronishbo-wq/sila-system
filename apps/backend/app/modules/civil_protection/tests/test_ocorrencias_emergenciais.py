...
def test_registrar_ocorrencia_emergencial_sucesso() -> None:
    ...
    async def scenario() -> None:
        ...
        corporacao = await corporacao_service.cadastrar_corporacao(
            nome="Corpo de Bombeiros Leste",
            municipio="Luanda",
            provincia="Luanda",
            endereco="Rua Leste",
            comandante="Comandante Leste",
        )
        ...
        ocorrencia = await ocorrencia_service.registrar_ocorrencia(
            ...
            descricao="Inundacao em area residencial com risco de isolamento",
            municipio="Luanda",
            provincia="Luanda",
            vitimas=2,
            desalojados=8,
    ...
    async def scenario() -> None:
        ...
        with pytest.raises(ValueError, match="nao pertence"):
            await ocorrencia_service.registrar_ocorrencia(
                ...
                bombeiro_responsavel_id=bombeiro_b.id,
                ...
                descricao="Desabamento parcial em mercado municipal",
                municipio="Luanda",
                provincia="Luanda",
            )
...
def test_atualizar_status_ocorrencia_emergencial() -> None:
    ...
    async def scenario() -> None:
        ...
        ocorrencia = await ocorrencia_service.registrar_ocorrencia(
            ...
            descricao="Incendio urbano controlado sem vitimas graves",
            municipio="Bengo",
            provincia="Bengo",
        )
        atualizada = await ocorrencia_service.atualizar_status(
            ocorrencia_id=ocorrencia.id,
            status=StatusOcorrenciaEmergencial.EM_ATENDIMENTO,
