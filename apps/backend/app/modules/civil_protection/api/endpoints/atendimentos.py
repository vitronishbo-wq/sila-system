...
from apps.backend.app.modules.civil_protection.application.dto.atendimento_schema import AtendimentoCreate, AtendimentoFinalizacao, AtendimentoResponse, AtendimentoStatusUpdate
