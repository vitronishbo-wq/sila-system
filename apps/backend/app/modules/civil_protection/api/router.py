...
from app.modules.civil_protection.api.endpoints import atendimentos_router, bombeiros_router, corporacoes_router, despachos_router, ocorrencias_emergenciais_router
