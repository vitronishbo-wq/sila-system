...
class OcorrenciaEmergencialService:
    ...
    async def registrar_ocorrencia(
        ...
        *,
        ...
        ocorrencia = OcorrenciaEmergencial.registrar(
        ...
        if self.request_service is not None:
            await self.request_service.create_request(
                request_type="REGISTRO_OCORRENCIA_EMERGENCIAL",
                entity_id=saved.id,
                citizen_id=citizen_id,
                numero_processo=saved.codigo_ocorrencia,
                metadata={
                    "codigo_ocorrencia": saved.codigo_ocorrencia,
                    "tipo": saved.tipo.value,
                    "prioridade": saved.prioridade.value,
    ...
    async def listar_ocorrencias(
        ...
        *,
        ...
        tipo: TipoOcorrenciaEmergencial | None = None,
        status: StatusOcorrenciaEmergencial | None = None,
