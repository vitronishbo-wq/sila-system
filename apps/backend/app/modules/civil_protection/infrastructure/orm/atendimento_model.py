...
class AtendimentoModel(Base):
    ...
    codigo_atendimento: Mapped[str] = mapped_column(
    ...
    inicio_atendimento: Mapped[datetime] = mapped_column(
        DateTime(timezone=False), nullable=False, index=True
    )
    fim_atendimento: Mapped[datetime | None] = mapped_column(
    ...
    equipe_responsavel_id: Mapped[uuid.UUID | None] = mapped_column(
