...
_ROLE_MAP = {
    RoleComercio.ROLE_MINISTERIO: RoleGovernance.ROLE_NACIONAL,
    RoleComercio.ROLE_DIRECAO_NACIONAL: RoleGovernance.ROLE_PROVINCIAL,
    RoleComercio.ROLE_UNIDADE: RoleGovernance.ROLE_UNIDADE,
    RoleComercio.ROLE_OPERADOR: RoleGovernance.ROLE_OPERADOR,
}


def _to_gov(role: RoleComercio) -> RoleGovernance:
