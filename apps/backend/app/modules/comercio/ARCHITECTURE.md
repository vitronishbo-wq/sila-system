...
Path:
/home/dev03wsl/sila-system/apps/backend/app/modules/comercio

## Purpose

Gerir capacidades do dominio governamental `comercio` no contexto federado `unknown`.

## Core Responsibilities

- Modelar regras de negocio do modulo `comercio`.
