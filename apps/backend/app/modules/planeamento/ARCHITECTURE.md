...
Path:
/home/dev03wsl/sila-system/apps/backend/app/modules/planeamento

## Purpose

Gerir capacidades do dominio governamental `planeamento` no contexto federado `unknown`.

## Core Responsibilities

- Modelar regras de negocio do modulo `planeamento`.
