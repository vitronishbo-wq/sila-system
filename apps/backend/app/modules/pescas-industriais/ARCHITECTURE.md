...
Domain: pescas-industriais

Path:
/home/dev03wsl/sila-system/apps/backend/app/modules/pescas-industriais

## Purpose

Gerir capacidades do dominio governamental `pescas-industriais` no contexto federado `unknown`.

## Core Responsibilities

- Modelar regras de negocio do modulo `pescas-industriais`.
