...
from app.modules.taxpayer.application.ports.taxpayer_repository import TaxpayerRepositoryPort
from app.modules.taxpayer.infrastructure.models.taxpayer_model import TaxpayerModel
from app.modules.taxpayer.domain.entities.taxpayer import Taxpayer
...
def _to_entity(model: TaxpayerModel) -> Taxpayer:
    return Taxpayer(
        ...
        nif=model.nif,
        name=model.name,
        status=__import__('app.modules.taxpayer.domain.enums.taxpayer_status', fromlist=['TaxpayerStatus']).TaxpayerStatus(model.status),
