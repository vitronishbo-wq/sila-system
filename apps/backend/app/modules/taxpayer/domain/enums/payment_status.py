...
class PaymentStatus(str, Enum):
    ...
    PENDING = "PENDING"  # Pendente - ainda não pago
    PROCESSING = "PROCESSING"  # Em processamento (verificação bancária)
    CONFIRMED = "CONFIRMED"  # Confirmado - pagamento recebido
    FAILED = "FAILED"  # Falhou - erro na transação
