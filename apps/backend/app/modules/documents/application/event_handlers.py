...
from apps.backend.app.modules.documents.domain.events import DocumentRegistered, DocumentStatusChanged, OfficialDocumentIssued, DocumentAuthenticated, DocumentArchived
...
async def handle_document_archived(event: DocumentArchived) -> None:
    ...
    pass
DOCUMENTS_EVENT_HANDLERS: dict[str, Callable[[DomainEvent], Awaitable[None]]] = {'DocumentRegistered': handle_document_registered, 'DocumentStatusChanged': handle_document_status_changed, 'OfficialDocumentIssued': handle_official_document_issued, 'DocumentAuthenticated': handle_document_authenticated, 'DocumentArchived': handle_document_archived}