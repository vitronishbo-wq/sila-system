...
Domain: seguranca-alimentar

Path:
/home/dev03wsl/sila-system/apps/backend/app/modules/seguranca-alimentar

## Purpose

Gerir capacidades do dominio governamental `seguranca-alimentar` no contexto federado `unknown`.

## Core Responsibilities

- Modelar regras de negocio do modulo `seguranca-alimentar`.
