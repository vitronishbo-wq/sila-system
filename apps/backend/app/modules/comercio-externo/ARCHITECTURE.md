...
Domain: comercio-externo

Path:
/home/dev03wsl/sila-system/apps/backend/app/modules/comercio-externo

## Purpose

Gerir capacidades do dominio governamental `comercio-externo` no contexto federado `unknown`.

## Core Responsibilities

- Modelar regras de negocio do modulo `comercio-externo`.
