...
class CadeiaCustodiaService:
    ...
    async def iniciar_cadeia(
        ...
        *,
        ...
        cadeia = CadeiaCustodia.iniciar(
            codigo_cadeia=codigo,
            prova_id=prova_id,
            ocorrencia_id=prova.ocorrencia_id,
        ...
        if self.request_service is not None:
            await self.request_service.create_request(
                request_type="INICIO_CADEIA_CUSTODIA",
                entity_id=saved.id,
                numero_processo=saved.codigo_cadeia,
                citizen_id=citizen_id,
                metadata={
                    "codigo_cadeia": saved.codigo_cadeia,
    ...
    async def listar_cadeias(
        self, *, status: StatusCadeiaCustodia | None = None
    ) -> list[CadeiaCustodia]:
