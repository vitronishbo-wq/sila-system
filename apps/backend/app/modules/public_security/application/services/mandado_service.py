...
class MandadoService:
    def __init__(
        self,
        *,
        mandado_repo: MandadoRepositoryPort,
    ...
    async def expedir_mandado(
        ...
        *,
        ...
        mandado = Mandado.expedir(
            numero_mandado=numero_mandado,
            ocorrencia_id=ocorrencia_id,
            tipo=tipo,
            autoridade_judicial=autoridade_judicial,
        ...
        if self.request_service is not None:
            await self.request_service.create_request(
                request_type="EXPEDICAO_MANDADO",
                entity_id=saved.id,
                numero_processo=saved.numero_mandado,
                citizen_id=citizen_id,
                metadata={
                    "numero_mandado": saved.numero_mandado,
    ...
    async def listar_mandados(
        ...
        *,
        ...
        status: StatusMandado | None = None,
    ) -> list[Mandado]:
    ...
    async def atualizar_status(
        self, *, mandado_id: UUID, status: StatusMandado, observacoes: str | None = None
    ) -> Mandado:
