...
class UnidadePolicialModel(Base):
    __tablename__ = 'seguranca_unidades_policiais'
    id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), primary_key=True, default=uuid.uuid4)
    codigo_unidade: Mapped[str] = mapped_column(String(50), unique=True, nullable=False, index=True)
