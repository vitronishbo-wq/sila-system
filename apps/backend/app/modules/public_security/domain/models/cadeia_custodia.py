    ...
    def iniciar(
        ...
        *,
        ...
        primeira_movimentacao = {
            ...
            "local": local_atual.strip(),
            "responsavel_id": str(responsavel_id),
        }
        return cls(
            id=uuid4(),
            codigo_cadeia=codigo_cadeia.strip(),
            prova_id=prova_id,
            ocorrencia_id=ocorrencia_id,
            status=StatusCadeiaCustodia.INICIADA,
            local_atual=local_atual.strip(),
            responsavel_id=responsavel_id,
            data_inicio=now,
            data_ultima_movimentacao=now,
            historico_movimentacoes=[primeira_movimentacao],
