...
from app.modules.public_security.domain.enums import PrioridadeOcorrencia, StatusEvidencia, TipoAgente, TipoEvidencia, TipoOcorrencia, TipoProva, TipoUnidadePolicial, TipoVestigio, TipoVinculo
from app.modules.public_security.tests._fakes import InMemoryCadeiaCustodiaRepository, InMemoryEvidenciaRepository, InMemoryOcorrenciaRepository, InMemoryPolicialRepository, InMemoryProvaPericialRepository, InMemoryUnidadePolicialRepository, InMemoryVestigioRepository
