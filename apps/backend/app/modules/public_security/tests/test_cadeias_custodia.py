...
from app.modules.public_security.domain.enums import PrioridadeOcorrencia, StatusCadeiaCustodia, TipoAgente, TipoOcorrencia, TipoProva, TipoUnidadePolicial, TipoVinculo
from app.modules.public_security.tests._fakes import InMemoryCadeiaCustodiaRepository, InMemoryOcorrenciaRepository, InMemoryPolicialRepository, InMemoryProvaPericialRepository, InMemoryUnidadePolicialRepository
