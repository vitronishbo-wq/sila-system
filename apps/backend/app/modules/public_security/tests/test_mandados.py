...
from app.modules.public_security.domain.enums import PrioridadeOcorrencia, StatusMandado, TipoAgente, TipoMandado, TipoOcorrencia, TipoUnidadePolicial, TipoVinculo
from app.modules.public_security.tests._fakes import InMemoryMandadoRepository, InMemoryOcorrenciaRepository, InMemoryPolicialRepository, InMemoryUnidadePolicialRepository
