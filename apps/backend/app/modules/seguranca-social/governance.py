...
class RoleSegurancaSocial(str, Enum):
...
_ROLE_MAP = {
    RoleSegurancaSocial.ROLE_MINISTERIO: RoleGovernance.ROLE_NACIONAL,
    RoleSegurancaSocial.ROLE_DIRECAO_NACIONAL: RoleGovernance.ROLE_PROVINCIAL,
    RoleSegurancaSocial.ROLE_MUNICIPIO: RoleGovernance.ROLE_MUNICIPAL,
    RoleSegurancaSocial.ROLE_UNIDADE: RoleGovernance.ROLE_UNIDADE,
    RoleSegurancaSocial.ROLE_OPERADOR: RoleGovernance.ROLE_OPERADOR,
}


def _to_gov(role: RoleSegurancaSocial) -> RoleGovernance:
