...
Domain: seguranca-social

Path:
/home/dev03wsl/sila-system/apps/backend/app/modules/seguranca-social

## Purpose

Gerir capacidades do dominio governamental `seguranca-social` no contexto federado `unknown`.

## Core Responsibilities

- Modelar regras de negocio do modulo `seguranca-social`.
