...
Domain: aviacao-civil

Path:
/home/dev03wsl/sila-system/apps/backend/app/modules/aviacao-civil

## Purpose

Gerir capacidades do dominio governamental `aviacao-civil` no contexto federado `unknown`.

## Core Responsibilities

- Modelar regras de negocio do modulo `aviacao-civil`.
