...
Domain: ciencia-pesquisa

Path:
/home/dev03wsl/sila-system/apps/backend/app/modules/ciencia-pesquisa

## Purpose

Gerir capacidades do dominio governamental `ciencia-pesquisa` no contexto federado `unknown`.

## Core Responsibilities

- Modelar regras de negocio do modulo `ciencia-pesquisa`.
