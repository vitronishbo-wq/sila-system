...
Path:
/home/dev03wsl/sila-system/apps/backend/app/modules/energia

## Purpose

Gerir capacidades do dominio governamental `energia` no contexto federado `unknown`.

## Core Responsibilities

- Modelar regras de negocio do modulo `energia`.
