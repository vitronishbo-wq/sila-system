...
_ROLE_MAP = {
    RoleIdentity.ROLE_MINISTERIO: RoleGovernance.ROLE_NACIONAL,
    RoleIdentity.ROLE_DIRECAO_NACIONAL: RoleGovernance.ROLE_PROVINCIAL,
    RoleIdentity.ROLE_UNIDADE: RoleGovernance.ROLE_UNIDADE,
    RoleIdentity.ROLE_OPERADOR: RoleGovernance.ROLE_OPERADOR,
}


def _to_gov(role: RoleIdentity) -> RoleGovernance:
