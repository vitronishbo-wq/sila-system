...
from apps.backend.app.modules.identity.subdomains.verifiable_credentials.application.services.revocation_service import (
    RevocationService,
)
...
def get_credential_status(
    ...
    include_status_list: bool = Query(default=False),
):
