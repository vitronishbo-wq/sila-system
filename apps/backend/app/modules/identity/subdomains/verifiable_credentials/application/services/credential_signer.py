...
class CredentialSigner:
    ...
    def sign(self, vc: VerifiableCredential, private_key_pem: bytes) -> VerifiableCredential:
        ...
        vc.proof = {'type': 'RsaSignature2018', 'created': datetime.utcnow().isoformat(), 'proofPurpose': 'assertionMethod', 'verificationMethod': f'{vc.issuer}#key-1', 'jws': base64.b64encode(signature).decode('utf-8')}
        return vc