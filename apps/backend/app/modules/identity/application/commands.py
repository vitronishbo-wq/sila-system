    ...
    async def handle(
        ...
        try:
            event = IdentityDocumentRequested(
                ...
                aggregate_type="IdentityDocument",
                event_type="IdentityDocumentRequested",
                ...
                metadata={
                    ...
                    "command_name": "RequestIdentityDocument",
...
class VerifyIdentityDocumentCommandHandler:
    ...
    async def handle(
        ...
        try:
            event = IdentityDocumentVerified(
                aggregate_id=document_id,
                aggregate_type="IdentityDocument",
                event_type="IdentityDocumentVerified",
                citizen_id=citizen_id,
                ...
                metadata={
                    "user_id": str(user_id) if user_id else None,
                    "command_name": "VerifyIdentityDocument",
                    "timestamp_utc": datetime.now(UTC).isoformat(),
                },
            )
            await self.event_bus.publish(event)
...
class EnrollBiometricDataCommandHandler:
    ...
    async def handle(
        ...
        try:
            event = BiometricDataEnrolled(
                aggregate_id=citizen_id,
                aggregate_type="BiometricData",
                event_type="BiometricDataEnrolled",
                citizen_id=citizen_id,
                ...
                metadata={
                    "user_id": str(user_id) if user_id else None,
                    "command_name": "EnrollBiometricData",
                    "timestamp_utc": datetime.now(UTC).isoformat(),
                },
            )
            await self.event_bus.publish(event)
