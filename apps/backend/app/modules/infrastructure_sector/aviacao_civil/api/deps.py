...
_aeronave_service = AeronaveService(aeronave_repo=_aeronave_repo, outbox=_outbox, anac_adapter=_anac_adapter)
_voo_service = VooService(voo_repo=_voo_repo, aeronave_repo=_aeronave_repo, outbox=_outbox, decea_adapter=_decea_adapter, meteorologia_adapter=_meteorologia_adapter)
