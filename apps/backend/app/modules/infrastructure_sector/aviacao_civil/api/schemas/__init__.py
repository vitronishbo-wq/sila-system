...
from apps.backend.app.modules.infrastructure_sector.aviacao_civil.api.schemas.aeroporto_schema import AeroportoResponse
...
__all__ = ['AeronaveCreate', 'AeronaveResponse', 'VooCreate', 'VooStatusInput', 'VooResponse', 'OcorrenciaCreate', 'OcorrenciaResponse', 'AeroportoResponse']