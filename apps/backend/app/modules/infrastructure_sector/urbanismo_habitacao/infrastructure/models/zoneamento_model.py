...
class ZoneamentoModel(Base):
    ...
    codigo_zoneamento: Mapped[str] = mapped_column(String(40), unique=True, nullable=False, index=True)
    ...
    coeficiente_aproveitamento_max: Mapped[Decimal | None] = mapped_column(Numeric(12, 4), nullable=True)
