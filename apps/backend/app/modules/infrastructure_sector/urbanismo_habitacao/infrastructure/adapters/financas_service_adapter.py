...
class FinancasServiceAdapter(FinancasServicePort):
    ...
    async def calcular_taxa_licenciamento(
        ...
        fator_tipo = {
            TipoAlvara.CONSTRUCAO: Decimal("1.00"),
            TipoAlvara.REFORMA: Decimal("0.70"),
            TipoAlvara.AMPLIACAO: Decimal("0.85"),
            TipoAlvara.DEMOLICAO: Decimal("0.50"),
            TipoAlvara.FUNCIONAMENTO: Decimal("0.40"),
            TipoAlvara.LOCALIZACAO: Decimal("0.35"),
        }[tipo_alvara]
