...
class Zoneamento:
    ...
    @classmethod
    def criar(cls, *, codigo_zoneamento: str, nome: str, tipo_zona: TipoZona, plano_diretor_id: UUID, provincia: str, usos_permitidos: list[UsoPermitido], municipio: str | None=None) -> 'Zoneamento':
        ...
        return cls(id=uuid4(), codigo_zoneamento=codigo_zoneamento.strip(), nome=nome.strip(), tipo_zona=tipo_zona, status=StatusZoneamento.ELABORACAO, plano_diretor_id=plano_diretor_id, provincia=provincia.strip(), municipio=municipio.strip() if municipio else None, usos_permitidos=usos_permitidos)
    ...
    def atualizar_parametros(self, *, usos_permitidos: list[UsoPermitido] | None=None, coeficiente_aproveitamento_max: Decimal | None=None, taxa_ocupacao_max: Decimal | None=None, gabarito_maximo: int | None=None, recuo_frontal_minimo: Decimal | None=None, permeabilidade_minima: Decimal | None=None, area_lote_minima: Decimal | None=None) -> None:
