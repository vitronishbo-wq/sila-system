...
class Loteamento:
    ...
    @classmethod
    def criar(cls, *, codigo_loteamento: str, nome: str, tipo: TipoLoteamento, parcelamento_id: UUID, plano_diretor_id: UUID, zoneamento_id: UUID, provincia: str, area_total: Decimal, quantidade_lotes_prevista: int, municipio: str | None=None, area_lotes: Decimal | None=None, area_verde: Decimal | None=None, area_institucional: Decimal | None=None, data_inicio_prevista: date | None=None, data_fim_prevista: date | None=None) -> 'Loteamento':
        ...
        return cls(id=uuid4(), codigo_loteamento=codigo_loteamento.strip(), nome=nome.strip(), tipo=tipo, status=StatusLoteamento.PROPOSTO, parcelamento_id=parcelamento_id, plano_diretor_id=plano_diretor_id, zoneamento_id=zoneamento_id, provincia=provincia.strip(), area_total=area_total, quantidade_lotes_prevista=quantidade_lotes_prevista, municipio=municipio.strip() if municipio else None, area_lotes=area_lotes, area_verde=area_verde, area_institucional=area_institucional, data_inicio_prevista=data_inicio_prevista, data_fim_prevista=data_fim_prevista)
