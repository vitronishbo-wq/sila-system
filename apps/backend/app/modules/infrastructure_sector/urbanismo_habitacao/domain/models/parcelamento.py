...
class Parcelamento:
    ...
    @classmethod
    def criar(cls, *, codigo_parcelamento: str, nome: str, tipo: TipoParcelamento, plano_diretor_id: UUID, zoneamento_id: UUID, provincia: str, area_total: Decimal, quantidade_unidades_prevista: int, municipio: str | None=None, area_publica_prevista: Decimal | None=None, area_sistema_viario_prevista: Decimal | None=None) -> 'Parcelamento':
        ...
        return cls(id=uuid4(), codigo_parcelamento=codigo_parcelamento.strip(), nome=nome.strip(), tipo=tipo, status=StatusParcelamento.ELABORACAO, plano_diretor_id=plano_diretor_id, zoneamento_id=zoneamento_id, provincia=provincia.strip(), area_total=area_total, quantidade_unidades_prevista=quantidade_unidades_prevista, municipio=municipio.strip() if municipio else None, area_publica_prevista=area_publica_prevista, area_sistema_viario_prevista=area_sistema_viario_prevista)
