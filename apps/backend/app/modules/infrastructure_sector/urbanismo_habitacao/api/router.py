...
from app.modules.infrastructure_sector.urbanismo_habitacao.api.endpoints import licencas_urbanisticas_router, loteamentos_router, operacoes_urbanas_router, parcelamentos_router, planos_diretores_router, zoneamento_router
