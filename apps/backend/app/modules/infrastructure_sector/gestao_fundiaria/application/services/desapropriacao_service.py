...
class DesapropriacaoService:
    def __init__(
        self,
        *,
        desapropriacao_repo: DesapropriacaoRepositoryPort,
    ...
    async def instaurar(
        ...
        *,
        ...
        if existente:
            raise DesapropriacaoAlreadyExistsError(
                "Ja existe desapropriacao com este numero de processo"
            )
        processo = Desapropriacao.instaurar(
    ...
    async def registrar_pagamento(
        self, numero_processo: str, *, data_pagamento: date | None = None
    ) -> Desapropriacao:
        item = await self._obter_ou_erro(numero_processo)
    ...
    async def listar(
        ...
        *,
        ...
        return await self._desapropriacao_repo.list(
