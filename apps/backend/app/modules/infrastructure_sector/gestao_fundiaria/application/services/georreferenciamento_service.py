...
class GeorreferenciamentoService:
    ...
    def __init__(self, *, georreferenciamento_repo: GeorreferenciamentoRepositoryPort, imovel_repo: ImovelRepositoryPort, geosampa_adapter: GeosampaServicePort | None=None) -> None:
    ...
    async def registrar(self, *, imovel_inscricao: str, latitude: Decimal, longitude: Decimal, sistema_referencia: str='WGS84', precisao_metros: Decimal | None=None, area_calculada: Decimal | None=None, codigo_geo: str | None=None) -> Georreferenciamento:
        ...
        if existente:
            raise GeorreferenciamentoAlreadyExistsError('Ja existe georreferenciamento com este codigo')
        ...
        item = Georreferenciamento.registrar(codigo_geo=codigo, imovel_inscricao=imovel_inscricao, latitude=latitude, longitude=longitude, sistema_referencia=sistema_referencia, precisao_metros=precisao_metros, area_calculada=area_calculada)
    ...
    async def atualizar_ponto(self, codigo_geo: str, *, latitude: Decimal, longitude: Decimal) -> Georreferenciamento:
    ...
    async def listar(self, *, imovel_inscricao: str | None=None, validado: bool | None=None, ativo: bool | None=None) -> list[Georreferenciamento]:
        return await self._georreferenciamento_repo.list(imovel_inscricao=imovel_inscricao, validado=validado, ativo=ativo)
