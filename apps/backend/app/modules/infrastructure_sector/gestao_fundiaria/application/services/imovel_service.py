...
class ImovelService:
    ...
    async def atualizar_proprietario(
        self, inscricao_imobiliaria: str, *, proprietario_id: UUID
    ) -> Imovel:
        item = await self._obter_ou_erro(inscricao_imobiliaria)
    ...
    async def atualizar_situacao(
        self, inscricao_imobiliaria: str, *, situacao: SituacaoDominial
    ) -> Imovel:
        item = await self._obter_ou_erro(inscricao_imobiliaria)
    ...
    async def listar(
        ...
        *,
        ...
        return await self._imovel_repo.list(
