...
class Proprietario:
    ...
    def cadastrar(
        ...
        *,
        ...
        if percentual_titularidade is not None and (
            percentual_titularidade <= Decimal("0") or percentual_titularidade > Decimal("100")
        ):
        ...
        return cls(
            ...
            percentual_titularidade=percentual_titularidade.quantize(Decimal("0.01"))
            if percentual_titularidade is not None
            else None,
    ...
    def atualizar_contato(
        self, *, email: str | None = None, telefone: str | None = None, endereco: str | None = None
    ) -> None:
    ...
    def atualizar_titularidade(
        self, *, tipo_titularidade: TipoTitularidade, percentual_titularidade: Decimal | None = None
    ) -> None:
        if percentual_titularidade is not None and (
            percentual_titularidade <= Decimal("0") or percentual_titularidade > Decimal("100")
        ):
        ...
        self.percentual_titularidade = (
            percentual_titularidade.quantize(Decimal("0.01"))
            if percentual_titularidade is not None
            else None
        )
        self.data_atualizacao = date.today()
