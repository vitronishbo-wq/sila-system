    ...
    def registrar(
        ...
        *,
        ...
        return cls(
            ...
            sistema_referencia=sistema_referencia.strip().upper(),
            data_registro=date.today(),
            precisao_metros=precisao_metros.quantize(Decimal("0.01"))
            if precisao_metros is not None
            else None,
            area_calculada=area_calculada.quantize(Decimal("0.01"))
