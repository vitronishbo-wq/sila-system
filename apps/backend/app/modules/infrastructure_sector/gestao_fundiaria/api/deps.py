...
from app.modules.infrastructure_sector.gestao_fundiaria.infrastructure.adapters.ambiente_service_adapter import AmbienteServiceAdapter
from app.modules.infrastructure_sector.gestao_fundiaria.infrastructure.adapters.justica_service_adapter import JusticaServiceAdapter
from app.modules.infrastructure_sector.gestao_fundiaria.infrastructure.repositories import SQLAlchemyGeorreferenciamentoRepository, SQLAlchemyDesapropriacaoRepository, SQLAlchemyImovelRepository, SQLAlchemyMatriculaImovelRepository, SQLAlchemyOneracaoRepository, SQLAlchemyProprietarioRepository
from app.modules.infrastructure_sector.gestao_fundiaria.infrastructure.adapters.geosampa_service_adapter import GeosampaServiceAdapter
