...
from app.modules.infrastructure_sector.gestao_fundiaria.api.endpoints import desapropriacoes_router, georreferenciamentos_router, imoveis_router, matriculas_router, oneracoes_router, proprietarios_router
