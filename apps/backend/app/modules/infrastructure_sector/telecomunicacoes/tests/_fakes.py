...
from app.modules.infrastructure_sector.telecomunicacoes.domain.enums import StatusIndicadorQualidade, StatusEspectro, StatusOutorga, StatusQualidadeServico, StatusSLA, TipoEspectro, TipoServico
