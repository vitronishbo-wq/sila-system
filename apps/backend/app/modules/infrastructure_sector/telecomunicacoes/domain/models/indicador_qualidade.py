...
class IndicadorQualidade:
    ...
    def registrar(
        ...
        *,
        ...
        return cls(
            id=uuid4(),
            codigo_indicador=codigo_indicador.strip(),
            operadora_id=operadora_id,
            referencia_ano=referencia_ano,
            referencia_mes=referencia_mes,
            total_medicoes=total_medicoes,
            disponibilidade_media_percentual=disponibilidade_media_percentual,
            latencia_media_ms=latencia_media_ms,
            jitter_medio_ms=jitter_medio_ms,
            perda_pacotes_media_percentual=perda_pacotes_media_percentual,
