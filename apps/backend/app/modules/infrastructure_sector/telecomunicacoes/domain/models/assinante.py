...
class Assinante:
    ...
    def cadastrar(
        ...
        *,
        ...
        return cls(
            id=uuid4(),
            codigo_assinante=codigo_assinante.strip(),
            ...
            telefone_contato=telefone_contato.strip() if telefone_contato else None,
            email_contato=email_contato.strip().lower() if email_contato else None,
            contrato_numero=contrato_numero.strip() if contrato_numero else None,
