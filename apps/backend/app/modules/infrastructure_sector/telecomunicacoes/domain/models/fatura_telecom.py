...
class FaturaTelecom:
    ...
    def gerar(
        ...
        *,
        ...
        excedente_gb = max(consumo_total_gb - franquia_gb, Decimal("0.00")).quantize(
            Decimal("0.01")
        )
        ...
        return cls(
            ...
            consumo_total_gb=consumo_total_gb.quantize(Decimal("0.01")),
            franquia_gb=franquia_gb.quantize(Decimal("0.01")),
            excedente_gb=excedente_gb,
            valor_plano=valor_plano.quantize(Decimal("0.01")),
            valor_excedente=valor_excedente.quantize(Decimal("0.01")),
            valor_total=valor_total,
            data_emissao=date.today(),
            data_vencimento=data_vencimento,
            status=StatusFaturaTelecom.PENDENTE,
        )
