...
from apps.backend.app.modules.infrastructure_sector.telecomunicacoes.domain.models.cobertura import Cobertura
from apps.backend.app.modules.infrastructure_sector.telecomunicacoes.domain.models.consumo_dados import ConsumoDados
...
from apps.backend.app.modules.infrastructure_sector.telecomunicacoes.domain.models.velocidade import Velocidade
__all__ = ['Operadora', 'Assinante', 'ConsumoDados', 'Franquia', 'FaturaTelecom', 'Reclamacao', 'Velocidade', 'Cobertura', 'InfraestruturaTelco', 'OutorgaEspectro', 'Espectro', 'SLA', 'QualidadeServico', 'IndicadorQualidade']