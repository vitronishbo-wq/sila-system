from apps.backend.app.modules.infrastructure_sector.telecomunicacoes.infrastructure.persistence.outbox import OutboxMessage, SQLAlchemyOutboxRepository
