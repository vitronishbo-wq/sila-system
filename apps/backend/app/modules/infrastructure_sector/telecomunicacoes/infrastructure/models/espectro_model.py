...
class EspectroModel(Base):
    ...
    codigo_espectro: Mapped[str] = mapped_column(String(50), unique=True, nullable=False, index=True)
    ...
    outorga_id: Mapped[uuid.UUID | None] = mapped_column(UUID(as_uuid=True), nullable=True, index=True)
