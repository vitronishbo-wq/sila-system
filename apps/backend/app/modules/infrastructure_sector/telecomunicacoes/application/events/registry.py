...
class TelecomEventRegistry:
    PUBLISHABLE_EVENTS = {
        FaturaTelecomGeradaEvent.event_name: "telecom.fatura.gerada",
        ReclamacaoTelecomAbertaEvent.event_name: "telecom.reclamacao.aberta",
        QualidadeServicoAferidaEvent.event_name: "telecom.qualidade.aferida",
    }
    _DESERIALIZERS = {
        FaturaTelecomGeradaEvent.event_name: FaturaTelecomGeradaEvent.from_payload,
        ReclamacaoTelecomAbertaEvent.event_name: ReclamacaoTelecomAbertaEvent.from_payload,
        QualidadeServicoAferidaEvent.event_name: QualidadeServicoAferidaEvent.from_payload,
    }
