...
class FaturaTelecomGeradaEvent(DomainEvent):
    ...
    def from_fatura(cls, fatura: FaturaTelecom) -> FaturaTelecomGeradaEvent:
        return cls(
            ...
            assinante_id=fatura.assinante_id,
    ...
    def to_payload(self) -> dict:
        return {
            ...
            "assinante_id": str(self.assinante_id),
    ...
    def from_payload(cls, payload: dict) -> FaturaTelecomGeradaEvent:
        return cls(
            ...
            assinante_id=UUID(payload["assinante_id"]),
...
class ReclamacaoTelecomAbertaEvent(DomainEvent):
    ...
    def from_reclamacao(cls, reclamacao: Reclamacao) -> ReclamacaoTelecomAbertaEvent:
        return cls(
            ...
            assinante_id=reclamacao.assinante_id,
            tipo=reclamacao.tipo.value,
    ...
    def to_payload(self) -> dict:
        return {
            ...
            "timestamp": self.timestamp.isoformat(),
            "version": self.version,
            "reclamacao_id": str(self.reclamacao_id),
    ...
    def from_payload(cls, payload: dict) -> ReclamacaoTelecomAbertaEvent:
        return cls(
            event_id=UUID(payload["event_id"]),
            timestamp=datetime.fromisoformat(payload["timestamp"]),
            reclamacao_id=UUID(payload["reclamacao_id"]),
...
class QualidadeServicoAferidaEvent(DomainEvent):
    ...
    def to_payload(self) -> dict:
        return {
            ...
            "assinante_id": str(self.assinante_id),
            "referencia": self.referencia,
            "download_mbps": str(self.download_mbps),
            "upload_mbps": str(self.upload_mbps),
            "latencia_ms": str(self.latencia_ms),
    ...
    def from_payload(cls, payload: dict) -> QualidadeServicoAferidaEvent:
        return cls(
            ...
            assinante_id=UUID(payload["assinante_id"]),
            referencia=payload["referencia"],
            download_mbps=Decimal(payload["download_mbps"]),
            upload_mbps=Decimal(payload["upload_mbps"]),
            latencia_ms=Decimal(payload["latencia_ms"]),
