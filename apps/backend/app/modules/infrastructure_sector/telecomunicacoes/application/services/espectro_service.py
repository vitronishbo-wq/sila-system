...
class EspectroService:
    def __init__(
        self,
        *,
        espectro_repo: EspectroRepositoryPort,
    ...
    async def registrar_espectro(
        ...
        *,
        ...
        espectro = Espectro.registrar(
            codigo_espectro=codigo,
            tipo=tipo,
        ...
        if self.request_service is not None:
            await self.request_service.create_request(
                request_type="REGISTRO_ESPECTRO_TELECOM",
                entity_id=saved.id,
                numero_processo=saved.codigo_espectro,
                metadata={
                    "codigo_espectro": saved.codigo_espectro,
