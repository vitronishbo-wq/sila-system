...
class QualidadeServicoService:
    ...
    async def registrar_medicao(
        ...
        *,
        ...
        medicao = QualidadeServico.registrar(
            codigo_medicao=codigo,
        ...
        if self.request_service is not None:
            await self.request_service.create_request(
                request_type="MEDICAO_QUALIDADE_TELECOM",
                entity_id=saved.id,
                numero_processo=saved.codigo_medicao,
                metadata={
                    "codigo_medicao": saved.codigo_medicao,
                    "operadora_id": str(saved.operadora_id),
                    "servico": saved.servico.value,
                    "status": saved.status.value,
                },
                citizen_id=assinante_id,
            )
        return saved
    ...
    async def listar_medicoes(
        ...
        *,
        ...
        assinante_id: UUID | None = None,
        status: StatusQualidadeServico | None = None,
    ...
    async def atualizar_status(
        self, *, medicao_id: UUID, status: StatusQualidadeServico
    ) -> QualidadeServico:
