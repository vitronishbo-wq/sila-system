...
class InfraestruturaService:
    def __init__(
        self,
        *,
        infraestrutura_repo: InfraestruturaRepositoryPort,
    ...
    async def cadastrar_infraestrutura(
        ...
        *,
        ...
        infraestrutura = InfraestruturaTelco.cadastrar(
            codigo_infra=codigo,
        ...
        if self.request_service is not None:
            await self.request_service.create_request(
                request_type="CADASTRO_INFRAESTRUTURA_TELECOM",
                entity_id=saved.id,
                numero_processo=saved.codigo_infra,
                metadata={
                    "codigo_infra": saved.codigo_infra,
    ...
    async def atualizar_status(
        self, *, infraestrutura_id: UUID, status: StatusInfraestrutura
    ) -> InfraestruturaTelco:
