...
Path:
/home/dev03wsl/sila-system/apps/backend/app/modules/estatistica

## Purpose

Gerir capacidades do dominio governamental `estatistica` no contexto federado `unknown`.

## Core Responsibilities

- Modelar regras de negocio do modulo `estatistica`.
