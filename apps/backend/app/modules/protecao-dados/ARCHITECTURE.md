...
Domain: protecao-dados

Path:
/home/dev03wsl/sila-system/apps/backend/app/modules/protecao-dados

## Purpose

Gerir capacidades do dominio governamental `protecao-dados` no contexto federado `unknown`.

## Core Responsibilities

- Modelar regras de negocio do modulo `protecao-dados`.
