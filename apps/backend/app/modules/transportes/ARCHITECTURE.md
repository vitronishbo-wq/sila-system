...
Path:
/home/dev03wsl/sila-system/apps/backend/app/modules/transportes

## Purpose

Gerir capacidades do dominio governamental `transportes` no contexto federado `unknown`.

## Core Responsibilities

- Modelar regras de negocio do modulo `transportes`.
