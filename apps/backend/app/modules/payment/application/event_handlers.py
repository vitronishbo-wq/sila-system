...
from apps.backend.app.modules.payment.domain.events import PaymentTransactionInitiated, PaymentProcessed, PaymentStatusChanged, InvoiceIssued, PaymentReconciled
...
async def handle_payment_reconciled(event: PaymentReconciled) -> None:
    ...
    pass
PAYMENT_EVENT_HANDLERS: dict[str, Callable[[DomainEvent], Awaitable[None]]] = {'PaymentTransactionInitiated': handle_payment_transaction_initiated, 'PaymentProcessed': handle_payment_processed, 'PaymentStatusChanged': handle_payment_status_changed, 'InvoiceIssued': handle_invoice_issued, 'PaymentReconciled': handle_payment_reconciled}