...
class BilhetagemService:
    def __init__(
        ...
        *,
        ...
        self._domain = BilhetagemDomainService(
            bilhetagem_repo=bilhetagem_repo,
    ...
    async def registrar_evento(
        ...
        *,
        ...
        return await self._domain.registrar_evento(
    ...
    async def reconciliar_evento(
        ...
        return await self._domain.reconciliar_evento(
            evento_id, confirmado=confirmado, referencia_externa=referencia_externa
        )
    ...
    async def listar_eventos(
        ...
        *,
        ...
        return await self._domain.listar_eventos(
            viagem_id=viagem_id,
            codigo_bilhete=codigo_bilhete,
