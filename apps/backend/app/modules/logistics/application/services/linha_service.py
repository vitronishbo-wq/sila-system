...
class LinhaService:
    def __init__(
        ...
        *,
        ...
        self._domain = LinhaDomainService(
            linha_repo=linha_repo,
            veiculo_repo=veiculo_repo,
            geosampa_adapter=geosampa_adapter,
            urbanismo_adapter=urbanismo_adapter,
            obras_publicas_adapter=obras_publicas_adapter,
    ...
    async def criar_linha(
        ...
        *,
        ...
        return await self._domain.criar_linha(
            nome=nome,
            modal=modal,
    ...
    async def cadastrar_veiculo(
        ...
        *,
        ...
        return await self._domain.cadastrar_veiculo(
            placa=placa,
            tipo=tipo,
            marca=marca,
            modelo=modelo,
    ...
    async def registrar_indicadores(
        ...
        *,
        ...
        return await self._domain.registrar_indicadores(
            codigo_linha,
    ...
    async def listar_linhas(
        ...
        *,
        ...
        return await self._domain.listar_linhas(
    ...
    async def listar_veiculos(
        ...
        *,
        ...
        return await self._domain.listar_veiculos(
            status=status, tipo=tipo, operadora_id=operadora_id
        )
