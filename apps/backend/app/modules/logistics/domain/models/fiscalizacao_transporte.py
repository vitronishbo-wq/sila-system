...
class FiscalizacaoTransporte:
    ...
    def registrar(
        ...
        *,
        ...
        return cls(
            ...
            apontamentos=apontamentos.strip(),
            data_fiscalizacao=data_fiscalizacao or date.today(),
            auto_infracao=auto_infracao.strip() if auto_infracao else None,
    ...
    def to_dict(self) -> dict:
        return {
            ...
            "data_fiscalizacao": self.data_fiscalizacao.isoformat(),
