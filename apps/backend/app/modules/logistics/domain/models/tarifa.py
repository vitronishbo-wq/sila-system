...
class Tarifa:
    ...
    def definir(
        ...
        *,
        ...
        if (
            ...
            and (data_fim_vigencia <= data_inicio_vigencia)
        ):
    ...
    def to_dict(self) -> dict:
        return {
            ...
            "data_inicio_vigencia": self.data_inicio_vigencia.isoformat(),
            "data_fim_vigencia": self.data_fim_vigencia.isoformat()
            if self.data_fim_vigencia
            else None,
            "motivo": self.motivo,
        }
