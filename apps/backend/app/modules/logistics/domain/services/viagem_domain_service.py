...
class ViagemDomainService:
    ...
    async def programar_viagem(
        ...
        *,
        ...
        conflito = await self._viagem_repo.has_active_for_veiculo(
            veiculo_id=veiculo_id, inicio=data_hora_saida, fim=data_hora_chegada_prevista
        )
        if conflito:
        ...
        viagem = Viagem.programar(
            ...
            data_hora_chegada_prevista=data_hora_chegada_prevista,
            origem=origem,
            destino=destino,
