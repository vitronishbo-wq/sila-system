...
class ClassificacaoVia(StrEnum):
    FEDERAL = "federal"
    ESTADUAL = "estadual"
    MUNICIPAL = "municipal"
...
class StatusFrota(StrEnum):
    ATIVA = "ativa"
    INATIVA = "inativa"
    SUSPENSA = "suspensa"


class StatusLinha(StrEnum):
    ATIVA = "ativa"
    INATIVA = "inativa"
    SUSPENSA = "suspensa"
...
class StatusVeiculoOperacional(StrEnum):
    ATIVO = "ativo"
...
class StatusReconciliacaoFinanceira(StrEnum):
    PENDENTE = "pendente"
...
class TipoFiscalizacao(StrEnum):
    ROTINA = "rotina"
    DENUNCIA = "denuncia"
...
class TipoAutoInfracao(StrEnum):
