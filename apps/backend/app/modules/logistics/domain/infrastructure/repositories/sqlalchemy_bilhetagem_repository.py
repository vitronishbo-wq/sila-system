...
from app.modules.logistics.application.ports import BilhetagemRepositoryPort
...
from app.modules.logistics.infrastructure.models import BilhetagemEventoModel
