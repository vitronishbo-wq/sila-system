...
class ViagemModel(Base):
    ...
    data_hora_saida: Mapped[datetime] = mapped_column(
        DateTime(timezone=False), nullable=False, index=True
    )
    data_hora_chegada_prevista: Mapped[datetime] = mapped_column(
    ...
    data_hora_chegada_real: Mapped[datetime | None] = mapped_column(
