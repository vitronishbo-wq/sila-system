from apps.backend.app.modules.logistics.infrastructure.orm.bilhetagem_evento_model import BilhetagemEventoModel
...
__all__ = ['ViagemModel', 'FrotaModel', 'LinhaModel', 'VeiculoModel', 'BilhetagemEventoModel', 'TollPassageModel']