...
Domain: obras-publicas

Path:
/home/dev03wsl/sila-system/apps/backend/app/modules/obras-publicas

## Purpose

Gerir capacidades do dominio governamental `obras-publicas` no contexto federado `unknown`.

## Core Responsibilities

- Modelar regras de negocio do modulo `obras-publicas`.
