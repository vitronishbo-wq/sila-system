...
_ROLE_MAP = {
    RoleFinancas.ROLE_MINISTERIO: RoleGovernance.ROLE_NACIONAL,
    RoleFinancas.ROLE_DIRECAO_NACIONAL: RoleGovernance.ROLE_PROVINCIAL,
    RoleFinancas.ROLE_UNIDADE: RoleGovernance.ROLE_UNIDADE,
    RoleFinancas.ROLE_OPERADOR: RoleGovernance.ROLE_OPERADOR,
}


def _to_gov(role: RoleFinancas) -> RoleGovernance:
