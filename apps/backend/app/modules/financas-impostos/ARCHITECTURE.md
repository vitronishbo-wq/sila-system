...
Domain: financas-impostos

Path:
/home/dev03wsl/sila-system/apps/backend/app/modules/financas-impostos

## Purpose

Gerir capacidades do dominio governamental `financas-impostos` no contexto federado `unknown`.

## Core Responsibilities

- Modelar regras de negocio do modulo `financas-impostos`.
