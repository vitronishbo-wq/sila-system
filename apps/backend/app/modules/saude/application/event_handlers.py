...
from apps.backend.app.modules.saude.domain.events import (
    ...
    HealthProviderStatusChanged,
    HealthVaccinationCompleted,
    MedicalLicenseIssued,
...
SAUDE_EVENT_HANDLERS: dict[str, Callable[[DomainEvent], Awaitable[None]]] = {
    "HealthProviderRegistered": handle_health_provider_registered,
    "MedicalVisitRecorded": handle_medical_visit_recorded,
    "HealthVaccinationCompleted": handle_health_vaccination_completed,
    "HealthProviderStatusChanged": handle_health_provider_status_changed,
