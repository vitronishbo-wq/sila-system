...
from apps.backend.app.modules.saude.domain.enums import MedicationType, PrescriptionStatus
...
class Prescription:
    ...
    def dispense(self, items_dispensed: list[str] | None = None) -> None:
        ...
        self.updated_at = datetime.now()
        self.metadata["dispensed_items"] = items_dispensed or [
            i.medication_code for i in self.items
        ]
