...
class Pesquisador:
    ...
    def cadastrar(
        ...
        *,
        ...
        return cls(
            id=uuid4(),
            nome_completo=nome,
            documento_identificacao=documento_identificacao.strip(),
            email_institucional=email,
            instituicao_id=instituicao_id,
            unidade_pesquisa_id=unidade_pesquisa_id,
            area_conhecimento=area_conhecimento,
            nivel_formacao=nivel_formacao,
            tipo_vinculo=tipo_vinculo,
            status_vinculo=StatusVinculoPesquisador.ATIVO,
            data_inicio_vinculo=data_inicio_vinculo or date.today(),
            data_fim_vinculo=None,
            telefone=telefone.strip() if telefone else None,
            orcid=orcid.strip() if orcid else None,
            lattes_url=lattes_url.strip() if lattes_url else None,
            researcher_id=researcher_id.strip() if researcher_id else None,
            scopus_id=scopus_id.strip() if scopus_id else None,
            ativo=True,
        )
    ...
    def atualizar_vinculo(
        self,
        *,
        tipo_vinculo: TipoVinculoPesquisador | None = None,
        status_vinculo: StatusVinculoPesquisador | None = None,
        unidade_pesquisa_id: UUID | None = None,
    ) -> None:
        ...
        if status_vinculo is not None:
            ...
            self.ativo = status_vinculo in {
                StatusVinculoPesquisador.ATIVO,
                StatusVinculoPesquisador.AFASTADO,
            }
