    ...
    def cadastrar(
        ...
        *,
        ...
        return cls(
            ...
            resumo=resumo_normalizado,
            instituicao_id=instituicao_id,
            coordenador_id=coordenador_id,
            equipe_pesquisadores_ids=equipe,
            area_conhecimento=area_conhecimento,
            data_inicio=inicio,
            data_fim_prevista=data_fim_prevista,
            data_fim_real=None,
            status=StatusProjetoPesquisa.SUBMETIDO,
            palavras_chave=[item.strip() for item in palavras_chave or [] if item.strip()],
