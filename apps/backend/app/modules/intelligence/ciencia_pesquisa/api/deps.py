...
from apps.backend.app.modules.intelligence.ciencia_pesquisa.infrastructure.repositories.sqlalchemy_instituicao_pesquisa_repository import SQLAlchemyInstituicaoPesquisaRepository
from apps.backend.app.modules.intelligence.ciencia_pesquisa.infrastructure.repositories.sqlalchemy_pesquisador_repository import SQLAlchemyPesquisadorRepository
from apps.backend.app.modules.intelligence.ciencia_pesquisa.infrastructure.repositories.sqlalchemy_projeto_pesquisa_repository import SQLAlchemyProjetoPesquisaRepository
