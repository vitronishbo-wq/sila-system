...
router.include_router(plano_classificacao_router, prefix='/planos-classificacao', tags=['Planos de Classificação'])
router.include_router(tabela_temporalidade_router, prefix='/tabelas-temporalidade', tags=['Tabelas de Temporalidade'])
__all__ = ['router']