...
from apps.backend.app.modules.intelligence.operations.api.schemas import (
    OrderAttachDocumentsRequest,
    OrderCreateRequest,
    OrderResponse,
    PaymentResponse,
    ReceiptResponse,
...
async def attach_documents(
    order_id: UUID,
    payload: OrderAttachDocumentsRequest,
    service: OperationsService = Depends(get_operations_service),
    identity: IdentityContext = Depends(get_identity_context),
):
    try:
...
async def confirm_payment(
    reference: str,
    service: OperationsService = Depends(get_operations_service),
    _: IdentityContext = Depends(get_identity_context),
):
    try:
