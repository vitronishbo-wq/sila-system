...
class OperationalOrderModel(Base):
    ...
    documents: Mapped[list["OperationalOrderDocumentModel"]] = relationship(
        "OperationalOrderDocumentModel", back_populates="order", cascade="all, delete-orphan"
    )
    payments: Mapped[list["OperationalPaymentModel"]] = relationship(
        "OperationalPaymentModel", back_populates="order", cascade="all, delete-orphan"
    )
...
class OperationalOrderDocumentModel(Base):
    ...
    order_id: Mapped[uuid.UUID] = mapped_column(
        UUID(as_uuid=True),
        ForeignKey("operational_orders.id", ondelete="CASCADE"),
        index=True,
        nullable=False,
    )
    ...
    order: Mapped["OperationalOrderModel"] = relationship(
        "OperationalOrderModel", back_populates="documents"
    )
