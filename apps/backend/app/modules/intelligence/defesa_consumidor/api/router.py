...
from apps.backend.app.modules.intelligence.defesa_consumidor.api.endpoints import arbitragem_router, consumidores_router, estabelecimentos_router, mediacao_router, produtos_router, recalls_router, reclamacoes_router, sancoes_router
