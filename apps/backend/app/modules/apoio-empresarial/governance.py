...
class RoleApoioEmpresarial(str, Enum):
...
_ROLE_MAP = {
    RoleApoioEmpresarial.ROLE_MINISTERIO: RoleGovernance.ROLE_NACIONAL,
    RoleApoioEmpresarial.ROLE_DIRECAO_NACIONAL: RoleGovernance.ROLE_PROVINCIAL,
    RoleApoioEmpresarial.ROLE_UNIDADE: RoleGovernance.ROLE_UNIDADE,
    RoleApoioEmpresarial.ROLE_OPERADOR: RoleGovernance.ROLE_OPERADOR,
}


def _to_gov(role: RoleApoioEmpresarial) -> RoleGovernance:
    return _ROLE_MAP[role]


__all__ = [
    "RoleApoioEmpresarial",
    "RoleGovernance",
