...
Domain: apoio-empresarial

Path:
/home/dev03wsl/sila-system/apps/backend/app/modules/apoio-empresarial

## Purpose

Gerir capacidades do dominio governamental `apoio-empresarial` no contexto federado `unknown`.

## Core Responsibilities

- Modelar regras de negocio do modulo `apoio-empresarial`.
