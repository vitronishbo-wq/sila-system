...
class ReservaHotel:
    ...
    data_checkin_real: datetime | None = None
    data_checkout_real: datetime | None = None
    ...
    def criar(
        ...
        *,
        ...
        return cls(
            ...
            cliente_nacionalidade=cliente_nacionalidade.strip(),
            quartos=quartos,
            adultos=adultos,
            criancas=criancas,
            checkin=checkin,
