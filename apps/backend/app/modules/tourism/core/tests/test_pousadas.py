...
def test_cadastrar_pousada_sucesso() -> None:
    ...
    service = MeioHospedagemService(hotel_repo=hotel_repo, pousada_repo=pousada_repo, citizen_service=citizen_service)
    result = asyncio.run(service.cadastrar_pousada(nome='Pousada Ilha', classificacao=ClassificacaoHoteleira.CONFORT, cnpj='98.765.432/0001-10', endereco='Rua da Ilha', numero='15', bairro='Ilha', municipio='Luanda', provincia='Luanda', cep='1000', telefone='222000111', email='contato@pousadailha.ao', quartos=20, capacidade_maxima=40, proprietario_id=proprietario_id))
