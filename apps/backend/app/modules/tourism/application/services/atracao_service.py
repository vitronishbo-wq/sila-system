...
class AtracaoService:
    ...
    async def listar(self, *, tipo: TipoAtracao | None=None, municipio: str | None=None, ativa: bool | None=None) -> list[AtracaoTuristica]:
        return await self.repository.list(tipo=tipo, municipio=municipio, ativa=ativa)

    async def atualizar(self, atracao_id: UUID, *, nome: str | None=None, tipo: TipoAtracao | None=None, descricao: str | None=None, endereco: str | None=None, municipio: str | None=None, provincia: str | None=None, horario_funcionamento: str | None=None, acessivel: bool | None=None, gratuita: bool | None=None, capacidade_visitantes_dia: int | None=None, valor_entrada: Decimal | None=None, latitude: Decimal | None=None, longitude: Decimal | None=None, observacoes: str | None=None, ativa: bool | None=None) -> AtracaoTuristica:
        atracao = await self.obter(atracao_id)
        atracao.atualizar(nome=nome, tipo=tipo, descricao=descricao, endereco=endereco, municipio=municipio, provincia=provincia, horario_funcionamento=horario_funcionamento, acessivel=acessivel, gratuita=gratuita, capacidade_visitantes_dia=capacidade_visitantes_dia, valor_entrada=valor_entrada, latitude=latitude, longitude=longitude, observacoes=observacoes)
        if ativa is True:
            atracao.ativar()
        if ativa is False:
            atracao.desativar()
