...
from ....trade.services.exceptions import EstabelecimentoComercialAlreadyExistsError, EstabelecimentoComercialNotFoundError, InvalidEstabelecimentoComercialStateError
