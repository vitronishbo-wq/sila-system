...
from ....trade.external.application.ports import SuspensaoRadarRepositoryPort
from ....trade.external.application.services.habilitacao_service_base import HabilitacaoServiceBase
from ....trade.external.domain.models import SuspensaoRadar
...
class SuspensaoRadarService(HabilitacaoServiceBase[SuspensaoRadar]):
    def __init__(self, *, repository: SuspensaoRadarRepositoryPort) -> None:
        super().__init__(
            ...
            entity_label="Suspensao de Radar",
        )
