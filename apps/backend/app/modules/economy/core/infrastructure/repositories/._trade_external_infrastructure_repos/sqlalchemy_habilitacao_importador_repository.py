...
from apps.backend.app.modules.economy.trade.external.infrastructure.models import HabilitacaoImportadorModel
...
class SQLAlchemyHabilitacaoImportadorRepository(SQLAlchemyHabilitacaoRepositoryBase[HabilitacaoImportador, HabilitacaoImportadorModel], HabilitacaoImportadorRepositoryPort):

    def __init__(self, session: AsyncSession):
        super().__init__(session, model_cls=HabilitacaoImportadorModel, domain_cls=HabilitacaoImportador)