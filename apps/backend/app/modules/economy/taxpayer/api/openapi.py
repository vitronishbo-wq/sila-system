...
taxpayer_tags = [
    {"name": "Contribuintes", "description": "Operações de gestão de contribuintes"},
    {"name": "Declarações", "description": "Submissão e consulta de declarações fiscais"},
    {"name": "Dívidas", "description": "Gestão de dívidas fiscais"},
    {"name": "Pagamentos", "description": "Processamento de pagamentos"},
    {"name": "Certidões", "description": "Solicitação de certidões fiscais"},
]
taxpayer_examples: dict[str, Any] = {
    ...
    "DebtResponse": {
        "value": {
            ...
            "tax_type": "IVA",
            "original_amount": 850000.0,
            "current_amount": 892500.0,
            "interest": 42500.0,
            "fines": 0.0,
