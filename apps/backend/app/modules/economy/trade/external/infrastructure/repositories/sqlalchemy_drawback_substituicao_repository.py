...
class SQLAlchemyDrawbackSubstituicaoRepository(
    SQLAlchemyHabilitacaoRepositoryBase[DrawbackSubstituicao, DrawbackSubstituicaoModel],
    DrawbackSubstituicaoRepositoryPort,
):
    def __init__(self, session: AsyncSession):
        super().__init__(
            session, model_cls=DrawbackSubstituicaoModel, domain_cls=DrawbackSubstituicao
        )
