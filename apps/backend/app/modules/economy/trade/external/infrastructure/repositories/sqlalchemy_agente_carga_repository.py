...
from app.modules.economy.trade.external.infrastructure.models import AgenteCargaModel
...
class SQLAlchemyAgenteCargaRepository(SQLAlchemyOperadorLogisticoRepositoryBase[AgenteCarga, AgenteCargaModel], AgenteCargaRepositoryPort):
