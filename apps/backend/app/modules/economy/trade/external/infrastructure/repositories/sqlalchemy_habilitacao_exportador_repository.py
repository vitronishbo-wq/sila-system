...
class SQLAlchemyHabilitacaoExportadorRepository(
    SQLAlchemyHabilitacaoRepositoryBase[HabilitacaoExportador, HabilitacaoExportadorModel],
    HabilitacaoExportadorRepositoryPort,
):
    def __init__(self, session: AsyncSession):
        super().__init__(
            session, model_cls=HabilitacaoExportadorModel, domain_cls=HabilitacaoExportador
        )
