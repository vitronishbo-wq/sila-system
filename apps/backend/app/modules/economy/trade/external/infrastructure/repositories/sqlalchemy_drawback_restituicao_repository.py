...
class SQLAlchemyDrawbackRestituicaoRepository(
    SQLAlchemyHabilitacaoRepositoryBase[DrawbackRestituicao, DrawbackRestituicaoModel],
    DrawbackRestituicaoRepositoryPort,
):
    def __init__(self, session: AsyncSession):
        super().__init__(
            session, model_cls=DrawbackRestituicaoModel, domain_cls=DrawbackRestituicao
        )
