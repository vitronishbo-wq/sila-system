...
class SQLAlchemyDrawbackVerdeAmareloRepository(
    SQLAlchemyHabilitacaoRepositoryBase[DrawbackVerdeAmarelo, DrawbackVerdeAmareloModel],
    DrawbackVerdeAmareloRepositoryPort,
):
    def __init__(self, session: AsyncSession):
        super().__init__(
            session, model_cls=DrawbackVerdeAmareloModel, domain_cls=DrawbackVerdeAmarelo
        )
