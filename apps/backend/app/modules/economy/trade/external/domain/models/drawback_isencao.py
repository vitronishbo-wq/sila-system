...
@dataclass
class DrawbackIsencao(HabilitacaoBase):

    @classmethod
    def solicitar(cls, *, tipo_pessoa: TipoPessoa, razao_social: str, cnpj_cpf: str, numero_processo: str, data_solicitacao: date) -> 'DrawbackIsencao':
