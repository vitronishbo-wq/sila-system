from apps.backend.app.modules.economy.trade.external.api.deps import (
    get_drawback_restituicao_service_protected,
)
...
router = build_habilitacao_router(
    prefix="/drawback_restituicao",
    tag="Comercio Externo - Drawback Restituicao",
    get_service=get_drawback_restituicao_service_protected,
    create_schema=DrawbackRestituicaoCreate,
    aprovacao_schema=DrawbackRestituicaoAprovacaoInput,
    rejeicao_schema=DrawbackRestituicaoRejeicaoInput,
    response_schema=DrawbackRestituicaoResponse,
