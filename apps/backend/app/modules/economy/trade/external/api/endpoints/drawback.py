from apps.backend.app.modules.economy.trade.external.api.deps import get_drawback_service_protected
...
router = build_operador_logistico_router(
    prefix="/drawback",
    tag="Comercio Externo - Drawback",
    get_service=get_drawback_service_protected,
    create_schema=DrawbackCreate,
    habilitacao_schema=HabilitacaoDrawbackInput,
    suspensao_schema=SuspensaoDrawbackInput,
    cancelamento_schema=CancelamentoDrawbackInput,
    response_schema=DrawbackResponse,
