...
router = build_habilitacao_router(
    prefix="/habilitacoes-exportador",
    tag="Comercio Externo - Habilitacoes Exportador",
    get_service=get_habilitacao_exportador_service,
    create_schema=HabilitacaoExportadorCreate,
    aprovacao_schema=HabilitacaoExportadorAprovacaoInput,
    rejeicao_schema=HabilitacaoExportadorRejeicaoInput,
    response_schema=HabilitacaoExportadorResponse,
