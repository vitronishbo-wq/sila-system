from apps.backend.app.modules.economy.trade.external.api.deps import (
    get_drawback_substituicao_service_protected,
)
...
router = build_habilitacao_router(
    prefix="/drawback_substituicao",
    tag="Comercio Externo - Drawback Substituicao",
    get_service=get_drawback_substituicao_service_protected,
    create_schema=DrawbackSubstituicaoCreate,
    aprovacao_schema=DrawbackSubstituicaoAprovacaoInput,
    rejeicao_schema=DrawbackSubstituicaoRejeicaoInput,
    response_schema=DrawbackSubstituicaoResponse,
