...
from apps.backend.app.modules.economy.trade.external.api.endpoints.drawback_interno import router as drawback_interno_router
...
from apps.backend.app.modules.economy.trade.external.api.endpoints.drawback_restituicao import router as drawback_restituicao_router
from apps.backend.app.modules.economy.trade.external.api.endpoints.drawback_substituicao import router as drawback_substituicao_router
from apps.backend.app.modules.economy.trade.external.api.endpoints.drawback_suspensao import router as drawback_suspensao_router
...
from apps.backend.app.modules.economy.trade.external.api.endpoints.siscomex_drawback import router as siscomex_drawback_router
__all__ = ['get_endpoint_routers', 'iter_endpoint_modules', 'agentes_carga_router', 'cancelamento_radar_router', 'despachantes_router', 'drawback_router', 'drawback_externo_router', 'drawback_interno_router', 'drawback_isencao_router', 'drawback_integrado_router', 'drawback_restituicao_router', 'drawback_substituicao_router', 'drawback_suspensao_router', 'drawback_verde_amarelo_router', 'siscomex_drawback_router', 'exportadores_router', 'habilitacoes_exportador_router', 'habilitacoes_importador_router', 'habilitacao_radar_router', 'importadores_router', 'radar_router', 'suspensao_radar_router', 'transportadores_internacionais_router']