...
router = build_operador_logistico_router(
    prefix="/agentes-carga",
    tag="Comercio Externo - Agentes de Carga",
    get_service=get_agente_carga_service,
    create_schema=AgenteCargaCreate,
    habilitacao_schema=HabilitacaoAgenteCargaInput,
    suspensao_schema=SuspensaoAgenteCargaInput,
    cancelamento_schema=CancelamentoAgenteCargaInput,
    response_schema=AgenteCargaResponse,
