...
from apps.backend.app.modules.economy.trade.services.application.ports import (
...
from apps.backend.app.modules.economy.trade.services.infrastructure.models import (
    EstabelecimentoComercialModel,
)
...
class SQLAlchemyEstabelecimentoComercialRepository(EstabelecimentoComercialRepositoryPort):
    ...
    def _to_domain(model: EstabelecimentoComercialModel) -> EstabelecimentoComercial:
        return EstabelecimentoComercial(
            ...
            cnaes_secundarios=model.cnaes_secundarios,
            ...
            dias_funcionamento=model.dias_funcionamento,
            area_m2=model.area_m2,
            numero_funcionarios=model.numero_funcionarios,
            faturamento_medio_mensal=model.faturamento_medio_mensal,
            matriz_id=model.matriz_id,
            franquia_id=model.franquia_id,
            ...
            licenca_sanitaria_id=model.licenca_sanitaria_id,
            licenca_ambiental_id=model.licenca_ambiental_id,
            certificacoes=model.certificacoes,
