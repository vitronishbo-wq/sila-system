...
from apps.backend.app.modules.economy.application.queries.economy_queries import GetInvoiceByIdQuery, ListInvoicesByCitizenQuery, ListPaymentsByCitizenQuery
...
class ListInvoicesByCitizenHandler:
    ...
    async def handle(self, query: ListInvoicesByCitizenQuery) -> List:
        """Execute query."""
        return await self.invoice_repo.list_by_citizen(query.citizen_id, limit=query.limit, offset=query.offset)
...
class ListPaymentsByCitizenHandler:
    ...
    async def handle(self, query: ListPaymentsByCitizenQuery) -> List:
        """Execute query."""
        return await self.payment_repo.list_by_citizen(query.citizen_id, limit=query.limit, offset=query.offset)