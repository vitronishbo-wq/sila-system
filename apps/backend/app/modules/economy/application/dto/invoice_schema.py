...
class CreateInvoiceSchema(BaseModel):
    ...
    class Config:
        schema_extra = {'example': {'citizen_id': '12345678901AB', 'service_code': 'EDU_PROPINA', 'service_name': 'School Tuition', 'revenue_code': '4211.08.01', 'cost_center': 'CC001', 'amount': 5000.0, 'due_date': '2026-04-12T23:59:59', 'currency': 'AOA', 'request_id': 'REQ-123456'}}