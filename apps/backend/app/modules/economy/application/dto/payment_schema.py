...
class CreatePaymentSchema(BaseModel):
    ...
    class Config:
        schema_extra = {'example': {'invoice_id': 'INV-001-2026', 'citizen_id': '12345678901AB', 'amount': 5000.0, 'currency': 'AOA', 'gateway_reference': 'GW-PAY-2026-031201', 'payment_method': 'credit_card'}}