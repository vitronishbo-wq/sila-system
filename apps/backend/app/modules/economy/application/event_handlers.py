...
from apps.backend.app.modules.economy.domain.events import (
    ...
    EconomicAgentStatusChanged,
    EconomicLicenseObtained,
...
ECONOMY_EVENT_HANDLERS: dict[str, Callable[[DomainEvent], Awaitable[None]]] = {
    "EconomicAgentRegistered": handle_economic_agent_registered,
    "EconomicActivityStarted": handle_economic_activity_started,
    "EconomicAgentStatusChanged": handle_economic_agent_status_changed,
    "TaxRegistrationIssued": handle_tax_registration_issued,
    "EconomicLicenseObtained": handle_economic_license_obtained,
}
