...
async def handle_citizen_identity_document_issued(event: CitizenIdentityDocumentIssued) -> None:
    ...
    """
    logger.info(
        f"Identity document {event.document_number} issued for citizen {event.aggregate_id}"
    )
    pass
...
async def handle_birth_record_certificate_issued(event: BirthRecordCertificateIssued) -> None:
    ...
    logger.info(
        f"Birth certificate {event.certificate_number} issued for record {event.aggregate_id}"
    )
    pass
...
async def handle_marriage_certificate_issued(event: MarriageCertificateIssued) -> None:
    ...
    logger.info(
        f"Marriage certificate {event.certificate_number} issued for marriage {event.aggregate_id}"
    )
    pass
...
async def handle_death_certificate_issued(event: DeathCertificateIssued) -> None:
    ...
    logger.info(
        f"Death certificate {event.certificate_number} issued for death record {event.aggregate_id}"
    )
    pass


JUSTICE_EVENT_HANDLERS: dict[str, Callable[[DomainEvent], Awaitable[None]]] = {
    "CitizenCreated": handle_citizen_created,
    "CitizenIdentityDocumentIssued": handle_citizen_identity_document_issued,
    "BirthRecordCreated": handle_birth_record_created,
    "BirthRecordCertificateIssued": handle_birth_record_certificate_issued,
    "MarriageRecorded": handle_marriage_recorded,
    "MarriageCertificateIssued": handle_marriage_certificate_issued,
    "DeathRecorded": handle_death_recorded,
