...
from app.modules.justice.bounded_contexts.application.services.birth_service import BirthService
...
def get_birth_service(db=Depends(get_db)):
    from app.modules.justice.bounded_contexts.infrastructure.repositories.birth_repository import BirthRepository
