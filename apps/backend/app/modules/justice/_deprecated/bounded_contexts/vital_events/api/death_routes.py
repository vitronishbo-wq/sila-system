...
from app.modules.justice.bounded_contexts.application.services.death_service import DeathService
...
def get_death_service(db=Depends(get_db)):
    from app.modules.justice.bounded_contexts.infrastructure.repositories.death_repository import DeathRepository
