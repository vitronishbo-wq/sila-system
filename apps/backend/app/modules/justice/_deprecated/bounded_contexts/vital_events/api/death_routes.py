...
from apps.backend.app.modules.justice.bounded_contexts.application.services.death_service import (
    DeathService,
)
...
death_service_dep = Depends(get_death_service)


def get_death_service(db=db_dep):
    from apps.backend.app.modules.justice.bounded_contexts.infrastructure.repositories.death_repository import (
        DeathRepository,
    )
...
async def register_death(
    payload: dict,
    service: DeathService = death_service_dep,
