...
class CitizenRepositoryPort(Protocol):
    ...
    async def get_by_id(self, citizen_id: UUID) -> Any | None: ...

    async def get_by_bi(self, bi_number: str) -> Any | None: ...

    async def get_by_national_id_number(self, national_id_number: str) -> Any | None: ...

    async def get_by_nif(self, nif: str) -> Any | None: ...
