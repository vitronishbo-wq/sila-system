...
class MarriageRecorded(AuditableEvent):
    ...
    first_spouse_id: Optional[UUID] = None
    second_spouse_id: Optional[UUID] = None
...
class DeathRecorded(AuditableEvent):
    ...
    deceased_id: Optional[UUID] = None
...
class DeathCertificateIssued(ComplianceEvent):
    ...
    def __post_init__(self):
        ...
        super().__post_init__()
__all__ = ['CitizenCreated', 'CitizenIdentityDocumentIssued', 'CitizenStatusChanged', 'BirthRecordCreated', 'BirthRecordCertificateIssued', 'MarriageRecorded', 'MarriageCertificateIssued', 'DeathRecorded', 'DeathCertificateIssued']