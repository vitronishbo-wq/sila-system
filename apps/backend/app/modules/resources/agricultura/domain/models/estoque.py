...
class Estoque:
    ...
    @classmethod
    def criar(cls, *, codigo_insumo: str, quantidade_atual: float, quantidade_minima: float) -> 'Estoque':
        ...
        return cls(id=uuid4(), codigo_estoque='', codigo_insumo=codigo_insumo, quantidade_atual=round(quantidade_atual, 3), quantidade_minima=round(quantidade_minima, 3), status=status, data_atualizacao=datetime.utcnow())
