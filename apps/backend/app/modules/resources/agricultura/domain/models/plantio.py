    ...
    def planejar(
        ...
        *,
        ...
        return cls(
            ...
            area_plantada_ha=round(area_plantada_ha, 2),
            quantidade_semente=round(quantidade_semente, 3)
            if quantidade_semente is not None
            else None,
            data_planejamento=date.today(),
            status=StatusPlantio.PLANEJADO,
        )
