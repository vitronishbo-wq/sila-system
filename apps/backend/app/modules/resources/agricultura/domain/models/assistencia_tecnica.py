...
class AssistenciaTecnica:
    ...
    @classmethod
    def agendar(cls, *, codigo_propriedade: str, tecnico_nome: str, objetivo: str) -> 'AssistenciaTecnica':
        return cls(id=uuid4(), codigo_assistencia='', codigo_propriedade=codigo_propriedade, tecnico_nome=tecnico_nome, objetivo=objetivo, status=StatusAssistencia.AGENDADA, data_agendamento=date.today())
