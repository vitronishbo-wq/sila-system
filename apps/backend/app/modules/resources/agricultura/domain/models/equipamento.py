...
class Equipamento:
    ...
    @classmethod
    def cadastrar(cls, *, nome: str, tipo: TipoEquipamento, fabricante: str | None=None, modelo: str | None=None, ano_fabricacao: int | None=None, data_aquisicao: date | None=None) -> 'Equipamento':
        ...
        return cls(id=uuid4(), codigo_equipamento='', nome=nome, tipo=tipo, fabricante=fabricante, modelo=modelo, ano_fabricacao=ano_fabricacao, data_aquisicao=data_aquisicao, status=StatusEquipamento.DISPONIVEL, horas_uso=0.0)
