...
class Colheita:
    ...
    @classmethod
    def registrar(cls, *, codigo_safra: str, codigo_talhao: str, quantidade_colhida_ton: float, perdas_ton: float=0.0, umidade_percentual: float | None=None, observacoes: str | None=None) -> 'Colheita':
        ...
        return cls(id=uuid4(), codigo_colheita='', codigo_safra=codigo_safra, codigo_talhao=codigo_talhao, quantidade_colhida_ton=round(quantidade_colhida_ton, 3), perdas_ton=round(perdas_ton, 3), data_colheita=date.today(), umidade_percentual=round(umidade_percentual, 2) if umidade_percentual is not None else None, observacoes=observacoes)
