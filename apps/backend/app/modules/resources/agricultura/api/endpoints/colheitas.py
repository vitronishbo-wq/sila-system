...
async def obter_colheita(
    codigo_colheita: str, service: ColheitaService = colheita_service_dep
):
    try:
...
async def listar_colheitas(
    ...
    service: ColheitaService = colheita_service_dep,
):
