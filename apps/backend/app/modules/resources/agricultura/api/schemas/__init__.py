from apps.backend.app.modules.resources.agricultura.api.schemas.assistencia_schema import (
    AssistenciaCancelamentoInput,
    AssistenciaConclusaoInput,
    AssistenciaCreate,
    AssistenciaResponse,
)
...
from apps.backend.app.modules.resources.agricultura.api.schemas.colheita_schema import (
    ColheitaCreate,
    ColheitaResponse,
)
...
from apps.backend.app.modules.resources.agricultura.api.schemas.cultura_schema import (
    CulturaCreate,
    CulturaResponse,
)
from apps.backend.app.modules.resources.agricultura.api.schemas.equipamento_schema import (
    EquipamentoCreate,
    EquipamentoResponse,
    UsoEquipamentoInput,
)
...
from apps.backend.app.modules.resources.agricultura.api.schemas.insumo_schema import (
    InsumoCreate,
    InsumoResponse,
    MovimentoInsumoInput,
)
...
from apps.backend.app.modules.resources.agricultura.api.schemas.propriedade_schema import (
    PropriedadeCreate,
    PropriedadeResponse,
)
