...
safra_service_singleton = SafraService(propriedade_service=propriedade_service_singleton, producao_service=producao_service_singleton)
estoque_service_singleton = EstoqueService(insumo_service=insumo_service_singleton)
operacao_service_singleton = OperacaoService(safra_service=safra_service_singleton, insumo_service=insumo_service_singleton)
fitossanidade_service_singleton = FitossanidadeService(propriedade_service=propriedade_service_singleton)
certificacao_service_singleton = CertificacaoService(propriedade_service=propriedade_service_singleton)
...
assistencia_service_singleton = AssistenciaService(propriedade_service=propriedade_service_singleton)
talhao_service_singleton = TalhaoService(propriedade_service=propriedade_service_singleton)
plantio_service_singleton = PlantioService(safra_service=safra_service_singleton, talhao_service=talhao_service_singleton)
colheita_service_singleton = ColheitaService(safra_service=safra_service_singleton, talhao_service=talhao_service_singleton)
...
async def get_produtor_service(session=Depends(get_db)) -> ProdutorService:
    ...
    return ProdutorService(produtor_repo=produtor_repo, citizen_service=citizen_service, request_service=request_service)
