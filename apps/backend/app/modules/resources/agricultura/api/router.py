...
from app.modules.resources.agricultura.api.endpoints import assistencia_router, certificacoes_router, colheitas_router, comercializacao_router, creditos_router, culturas_router, equipamentos_router, estoques_router, fitossanidade_router, insumos_router, operacoes_router, plantios_router, produtores_router, propriedades_router, safras_router, talhoes_router, zoneamento_router
