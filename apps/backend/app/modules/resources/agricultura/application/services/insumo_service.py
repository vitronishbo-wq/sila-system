...
class InsumoService:
    ...
    async def cadastrar(self, *, nome: str, tipo, unidade_medida: str, quantidade_inicial: float, custo_unitario: float) -> Insumo:
        item = Insumo.criar(nome=nome, tipo=tipo, unidade_medida=unidade_medida, quantidade_inicial=quantidade_inicial, custo_unitario=custo_unitario)
