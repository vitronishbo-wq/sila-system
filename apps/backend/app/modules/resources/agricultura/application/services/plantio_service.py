...
class PlantioService:
    ...
    async def planejar(self, *, codigo_safra: str, codigo_talhao: str, area_plantada_ha: float, quantidade_semente: float | None=None) -> Plantio:
        ...
        item = Plantio.planejar(codigo_safra=codigo_safra, codigo_talhao=codigo_talhao, area_plantada_ha=area_plantada_ha, quantidade_semente=quantidade_semente)
    ...
    async def listar(self, *, codigo_safra: str | None=None, codigo_talhao: str | None=None, status: StatusPlantio | None=None) -> list[Plantio]:
