...
from app.modules.resources.agricultura.domain.models.cultura import Cultura
...
class ProducaoService:
    ...
    async def cadastrar_cultura(self, *, nome: str, tipo, ciclo_dias: int, produtividade_estimada_ton_ha: float) -> Cultura:
        item = Cultura.criar(nome=nome, tipo=tipo, ciclo_dias=ciclo_dias, produtividade_estimada_ton_ha=produtividade_estimada_ton_ha)
