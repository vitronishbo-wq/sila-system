...
class ComercializacaoService:
    ...
    async def registrar_venda(self, *, codigo_safra: str, comprador: str, quantidade_ton: float, preco_unitario: float) -> Comercializacao:
        ...
        item = Comercializacao.registrar(codigo_safra=codigo_safra, comprador=comprador, quantidade_ton=quantidade_ton, preco_unitario=preco_unitario)
