...
from apps.backend.app.modules.resources.agricultura.domain.models.propriedade_rural import (
    PropriedadeRural,
)
...
class PropriedadeService:
    ...
    async def cadastrar(
        ...
        *,
        ...
        item = PropriedadeRural.criar(
            produtor_id=produtor_id,
            nome=nome,
            tipo=tipo,
            area_total_ha=area_total_ha,
            area_cultivavel_ha=area_cultivavel_ha,
            provincia=provincia,
            municipio=municipio,
        )
