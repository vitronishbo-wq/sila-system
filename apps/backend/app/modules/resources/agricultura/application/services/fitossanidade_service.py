...
class FitossanidadeService:
    ...
    async def registrar_ocorrencia(self, *, codigo_propriedade: str, praga_doenca: str, descricao: str, severidade, cultura_afetada: str | None=None, acao_recomendada: str | None=None) -> OcorrenciaFitossanitaria:
        await self._propriedade_service.obter(codigo_propriedade)
        item = OcorrenciaFitossanitaria.registrar(codigo_propriedade=codigo_propriedade, praga_doenca=praga_doenca, descricao=descricao, severidade=severidade, cultura_afetada=cultura_afetada, acao_recomendada=acao_recomendada)
    ...
    async def listar(self, *, codigo_propriedade: str | None=None, status: StatusOcorrencia | None=None) -> list[OcorrenciaFitossanitaria]:
