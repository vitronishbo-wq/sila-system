...
class DesembarqueService:
    ...
    async def registrar_desembarque(
        self, *, captura_id: UUID, porto_desembarque: str, quantidade_kg: Decimal
    ) -> Desembarque:
        item = Desembarque.registrar(
            captura_id=captura_id, porto_desembarque=porto_desembarque, quantidade_kg=quantidade_kg
        )
