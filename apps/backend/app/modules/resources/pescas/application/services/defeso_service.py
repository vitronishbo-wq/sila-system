...
class DefesoService:
    ...
    async def criar_defeso(
        self, *, periodo: PeriodoDefesoTipo, especie_id: UUID, data_inicio: date, data_fim: date
    ) -> Defeso:
        item = Defeso.criar(
            periodo=periodo, especie_id=especie_id, data_inicio=data_inicio, data_fim=data_fim
        )
