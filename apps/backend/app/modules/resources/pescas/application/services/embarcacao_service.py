...
class EmbarcacaoService:
    def __init__(
        self,
        embarcacao_repo: EmbarcacaoRepositoryPort,
    ...
    async def cadastrar_embarcacao(
        ...
        *,
        ...
        await self.request_service.create_request(
            request_type="CADASTRO_EMBARCACAO",
            entity_id=saved.id,
            citizen_id=proprietario_id,
            numero_processo=numero_inscricao,
            metadata={"nome": nome, "tipo": tipo.value},
        )
        return saved
