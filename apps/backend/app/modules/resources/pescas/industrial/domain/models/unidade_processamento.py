...
class UnidadeProcessamento:
    ...
    @classmethod
    def cadastrar(cls, *, cnpj: str, razao_social: str, tipo_processamento: list[TipoProcessamento], classificacao: ClassificacaoIndustrial, capacidade_kg_dia: Decimal, area_total_m2: Decimal, area_producao_m2: Decimal, area_armazenagem_m2: Decimal, numero_funcionarios: int, endereco: str, municipio: str, provincia: str) -> 'UnidadeProcessamento':
        ...
        return cls(id=uuid4(), cnpj=cnpj.strip(), razao_social=razao_social.strip(), tipo_processamento=list(tipo_processamento), classificacao=classificacao, capacidade_kg_dia=capacidade_kg_dia, area_total_m2=area_total_m2, area_producao_m2=area_producao_m2, area_armazenagem_m2=area_armazenagem_m2, numero_funcionarios=numero_funcionarios, endereco=endereco.strip(), municipio=municipio.strip(), provincia=provincia.strip(), data_inauguracao=date.today())
    ...
    def atualizar_responsavel_tecnico(self, *, responsavel_tecnico_id: UUID | None, responsavel_tecnico_registro: str | None) -> None:
        self.responsavel_tecnico_id = responsavel_tecnico_id
        self.responsavel_tecnico_registro = responsavel_tecnico_registro.strip() if responsavel_tecnico_registro else None