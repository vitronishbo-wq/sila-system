...
class ProdutoProcessado:
    ...
    @classmethod
    def cadastrar(cls, *, codigo_produto: str, unidade_processamento_id: UUID, nome_comercial: str, tipo_produto: TipoProdutoProcessado, tipo_processamento: TipoProcessamento, peso_liquido_kg: Decimal, rendimento_percentual: Decimal, mercado_destino: MercadoDestino, observacoes: str | None=None) -> 'ProdutoProcessado':
        ...
        return cls(id=uuid4(), codigo_produto=codigo_produto.strip(), unidade_processamento_id=unidade_processamento_id, nome_comercial=nome_comercial.strip(), tipo_produto=tipo_produto, tipo_processamento=tipo_processamento, peso_liquido_kg=peso_liquido_kg, rendimento_percentual=rendimento_percentual, mercado_destino=mercado_destino, data_registro=date.today(), observacoes=observacoes.strip() if observacoes else None)

    def atualizar(self, *, nome_comercial: str | None=None, tipo_produto: TipoProdutoProcessado | None=None, tipo_processamento: TipoProcessamento | None=None, peso_liquido_kg: Decimal | None=None, rendimento_percentual: Decimal | None=None, mercado_destino: MercadoDestino | None=None, ativo: bool | None=None, observacoes: str | None=None) -> None:
