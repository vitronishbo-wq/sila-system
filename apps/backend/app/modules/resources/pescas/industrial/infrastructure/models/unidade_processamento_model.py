...
class UnidadeProcessamentoModel(Base):
    ...
    tipo_processamento: Mapped[list[str]] = mapped_column(
    ...
    responsavel_tecnico_id: Mapped[uuid.UUID | None] = mapped_column(
    ...
    armador_id: Mapped[uuid.UUID | None] = mapped_column(
