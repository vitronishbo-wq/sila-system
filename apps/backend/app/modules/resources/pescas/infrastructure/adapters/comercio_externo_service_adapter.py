...
from app.modules.resources.pescas.application.ports import ComercioExternoServicePort
...
class ComercioExternoServiceAdapter(ComercioExternoServicePort):
    ...
    async def registrar_exportacao_pescado(self, *, captura_id: UUID, destino: str, quantidade_kg: Decimal) -> bool:
        return await self._service.registrar_exportacao_pescado(captura_id=captura_id, destino=destino, quantidade_kg=quantidade_kg)