...
async def test_emissao_publica_evento_e_worker_entrega_no_gateway():
    ...
    gateway = SimpleNamespace(
        registrar_fatura_agua=AsyncMock(return_value="FIN-AGUA-FAT-1"),
        registrar_pagamento_fatura_agua=AsyncMock(return_value="FIN-AGUA-PAG-1"),
    )
    ...
    fatura = await service.emitir(
        consumo_id=uuid4(),
        titular_id=uuid4(),
        referencia="2026-03",
        volume_m3=Decimal("15.00"),
        tarifa_m3=Decimal("20.00"),
