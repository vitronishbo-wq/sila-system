...
class AguasEventRegistry:
    PUBLISHABLE_EVENTS = {
        FaturaEmitidaEvent.event_name: "aguas.fatura.emitida",
        FaturaPagamentoRegistradoEvent.event_name: "aguas.fatura.pagamento_registrado",
    }
    _DESERIALIZERS = {
        FaturaEmitidaEvent.event_name: FaturaEmitidaEvent.from_payload,
        FaturaPagamentoRegistradoEvent.event_name: FaturaPagamentoRegistradoEvent.from_payload,
    }
