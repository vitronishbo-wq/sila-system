...
class FaturaEmitidaEvent:
    ...
    def to_payload(self) -> dict:
        return {
            ...
            "data_emissao": _to_iso_date(self.data_emissao),
            "data_vencimento": _to_iso_date(self.data_vencimento),
    ...
    def from_payload(cls, payload: dict) -> FaturaEmitidaEvent:
        return cls(
            ...
            titular_id=UUID(payload["titular_id"]),
            referencia=payload["referencia"],
            valor_total=Decimal(payload["valor_total"]),
            data_emissao=_from_iso_date(payload["data_emissao"]),
            data_vencimento=_from_iso_date(payload["data_vencimento"]),
...
class FaturaPagamentoRegistradoEvent:
    ...
    def from_fatura(cls, item: FaturaAgua) -> FaturaPagamentoRegistradoEvent:
        ...
        return cls(
            ...
            metodo_pagamento=item.metodo_pagamento.value,
        )
    ...
    def to_payload(self) -> dict:
        return {
            ...
            "data_pagamento": _to_iso_date(self.data_pagamento),
    ...
    def from_payload(cls, payload: dict) -> FaturaPagamentoRegistradoEvent:
        return cls(
            ...
            numero_fatura=payload["numero_fatura"],
            titular_id=UUID(payload["titular_id"]),
            valor_pago=Decimal(payload["valor_pago"]),
