...
class InfraestruturaRepositoryPort(ABC):
    ...
    @abstractmethod
    async def list(self, *, tipo: TipoInfraestrutura | None=None, status: StatusInfraestrutura | None=None, provincia: str | None=None, municipio: str | None=None) -> list[InfraestruturaHidrica]:
        pass
