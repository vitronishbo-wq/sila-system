...
from app.modules.resources.aguas_saneamento.api.endpoints import abastecimento_router, consumo_router, faturas_router, infraestrutura_router, outorgas_router
