    ...
    def registrar(
        ...
        *,
        ...
        return cls(
            ...
            capacidade=capacidade.quantize(Decimal("0.01")) if capacidade is not None else None,
            unidade_capacidade=unidade_capacidade.strip() if unidade_capacidade else None,
