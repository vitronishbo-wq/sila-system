...
from apps.backend.app.modules.resources.pecuaria.api.endpoints.producao import router as producao_router
...
from apps.backend.app.modules.resources.pecuaria.api.endpoints.sanidade import router as sanidade_router
