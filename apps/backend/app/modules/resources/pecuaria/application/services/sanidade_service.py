...
class SanidadeService:
    ...
    async def aplicar_vacina(self, *, animal_id: UUID, nome: str, data_aplicacao: date, proxima_dose: date | None=None) -> Vacina:
        item = Vacina.aplicar(animal_id=animal_id, nome=nome, data_aplicacao=data_aplicacao, proxima_dose=proxima_dose)
