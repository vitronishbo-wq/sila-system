...
class ReproducaoService:
    ...
    async def registrar(
        self, *, femea_id: UUID, metodo: str, data_evento: date, macho_id: UUID | None = None
    ) -> Reproducao:
        item = Reproducao.registrar(
            femea_id=femea_id, metodo=metodo, data_evento=data_evento, macho_id=macho_id
        )
