...
class RebanhoService:
    ...
    async def cadastrar(self, *, propriedade_id: UUID, tipo_animal: TipoAnimal, descricao: str, quantidade_animais: int=0) -> Rebanho:
        item = Rebanho.criar(propriedade_id=propriedade_id, tipo_animal=tipo_animal, descricao=descricao, quantidade_animais=quantidade_animais)
