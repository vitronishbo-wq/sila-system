...
async def test_cadastrar_pecuarista_sucesso():
    ...
    repo = SimpleNamespace(
        ...
        next_cadastro=AsyncMock(return_value="PEC/2026/000001"),
    ...
    result = await service.cadastrar_pecuarista(
        nome="Ana", documento="123456789", documento_tipo="BI", citizen_id=citizen_id
    )
...
def test_endpoint_cadastrar_pecuarista_retorna_201():
    ...
    response = client.post(
        "/pecuaria/pecuaristas/",
        json={
            "nome": "Carlos",
            "documento": "456",
            "documento_tipo": "BI",
            "citizen_id": str(item.citizen_id),
        },
    )
