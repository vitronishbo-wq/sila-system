...
from apps.backend.app.modules.resources.domain.events import (
    EnvironmentalImpactAssessmentApproved,
    ExploitationLicenseIssued,
    ResourceExplorationLicenseApplied,
    ResourceLicenseStatusChanged,
    ResourceMonitoringReportFiled,
)

logger = logging.getLogger(__name__)


async def handle_resource_exploration_license_applied(
    event: ResourceExplorationLicenseApplied,
) -> None:
...
RESOURCES_EVENT_HANDLERS: dict[str, Callable[[DomainEvent], Awaitable[None]]] = {
    "ResourceExplorationLicenseApplied": handle_resource_exploration_license_applied,
    ...
    "ResourceLicenseStatusChanged": handle_resource_license_status_changed,
    "EnvironmentalImpactAssessmentApproved": handle_eia_approved,
}
