...
cadastro_service_singleton = CadastroService(
    proprietario_repo=proprietario_repo_singleton,
    imovel_repo=imovel_repo_singleton,
    car_repo=car_repo_singleton,
)
licenciamento_service_singleton = LicenciamentoService(
    car_repo=car_repo_singleton, licenca_repo=licenca_repo_singleton
)
estudo_service_singleton = EstudoService(
    licenca_repo=licenca_repo_singleton, estudo_repo=estudo_repo_singleton
)
condicionante_service_singleton = CondicionanteService(
    licenca_repo=licenca_repo_singleton, condicionante_repo=condicionante_repo_singleton
)
fiscalizacao_service_singleton = FiscalizacaoService(
    licenca_repo=licenca_repo_singleton, fiscalizacao_repo=fiscalizacao_repo_singleton
)
penalidade_service_singleton = PenalidadeService(
    fiscalizacao_repo=fiscalizacao_repo_singleton,
    auto_infracao_repo=auto_infracao_repo_singleton,
    embargo_repo=embargo_repo_singleton,
    multa_repo=multa_repo_singleton,
)
