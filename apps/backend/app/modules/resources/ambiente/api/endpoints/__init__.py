...
from app.modules.resources.ambiente.api.endpoints.embargos import router as embargos_router
from app.modules.resources.ambiente.api.endpoints.multas import router as multas_router
__all__ = ['car_router', 'licencas_router', 'estudos_router', 'condicionantes_router', 'fiscalizacoes_router', 'autos_infracao_router', 'embargos_router', 'multas_router']