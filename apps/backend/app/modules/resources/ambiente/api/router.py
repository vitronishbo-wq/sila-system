...
from apps.backend.app.modules.resources.ambiente.api.endpoints import autos_infracao_router, car_router, condicionantes_router, embargos_router, estudos_router, fiscalizacoes_router, licencas_router, multas_router
