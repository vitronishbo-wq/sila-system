...
class LicencaAmbiental:
    ...
    def criar(cls, *, numero_car: str, tipo: TipoLicenca, atividade: str) -> 'LicencaAmbiental':
        ...
        return cls(id=uuid4(), numero_licenca='', numero_car=numero_car, tipo=tipo, atividade=atividade.strip(), status=StatusLicenca.REQUERIDA, data_requerimento=date.today(), condicionantes=[])
    ...
    def deferir(self, *, analista_id: UUID, data_validade: date, condicionantes: list[str] | None=None) -> None:
