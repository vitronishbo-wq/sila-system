...
class Fiscalizacao:
    ...
    @classmethod
    def agendar(cls, *, numero_licenca: str, localidade: str, objetivo: str, fiscal_responsavel: str, data_agendada: date) -> 'Fiscalizacao':
        ...
        return cls(id=uuid4(), numero_fiscalizacao='', numero_licenca=numero_licenca, localidade=localidade.strip(), objetivo=objetivo.strip(), fiscal_responsavel=fiscal_responsavel.strip(), status=StatusFiscalizacao.AGENDADA, data_agendada=data_agendada)
