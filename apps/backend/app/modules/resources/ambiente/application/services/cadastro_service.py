...
class CadastroService:
    def __init__(
        self,
        *,
        proprietario_repo: ProprietarioRepositoryPort,
        imovel_repo: ImovelRepositoryPort,
        car_repo: CARRepositoryPort,
    ) -> None:
    ...
    async def cadastrar_proprietario(
        self, *, nome: str, documento: str, telefone: str | None = None, email: str | None = None
    ) -> Proprietario:
    ...
    async def atualizar_areas(
        ...
        *,
        ...
        car.definir_areas(
            area_preservacao_permanente=area_preservacao_permanente,
            area_reserva_legal=area_reserva_legal,
            area_uso_alternativo=area_uso_alternativo,
