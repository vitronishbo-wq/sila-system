from apps.backend.app.modules.resources.ambiente.application.ports.agricultura_service_port import (
...
from apps.backend.app.modules.resources.ambiente.application.ports.citizen_service_port import (
    CitizenServicePort,
)
...
from apps.backend.app.modules.resources.ambiente.application.ports.estudo_repository_port import (
...
from apps.backend.app.modules.resources.ambiente.application.ports.geosampa_service_port import (
    GeosampaServicePort,
)
...
from apps.backend.app.modules.resources.ambiente.application.ports.request_service_port import (
    RequestServicePort,
)
