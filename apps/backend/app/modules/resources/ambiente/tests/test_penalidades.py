...
from apps.backend.app.modules.resources.ambiente.api.endpoints.autos_infracao import router as autos_infracao_router
...
from apps.backend.app.modules.resources.ambiente.domain.enums import Bioma, StatusAutoInfracao, StatusEmbargo, StatusMulta, TipoAutoInfracao, TipoImovel, TipoLicenca
