...
class UnidadeManejo:
    ...
    coordenadas_centroide: str | None = None
    arquivo_shp: str | None = None
    ...
    def cadastrar(
        ...
        *,
        ...
        return cls(
            ...
            area_manejo_ha=area_total_ha * Decimal("0.8"),
            area_preservacao_ha=area_total_ha * Decimal("0.2"),
    ...
    def aprovar_plano(
        self, *, plano_manejo_id: UUID, data_aprovacao: date, data_validade: date
    ) -> None:
