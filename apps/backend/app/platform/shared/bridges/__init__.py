...
from apps.backend.app.core import bridges as _core_bridges
...
_SUBMODULES = [
    ...
    "citizen_repository_port_bridge",
    "civil_identity_bridge",
    "cross_domain_ports_bridge",
    "emprego_bridge",
    "finance_bridge",
    "governance_service_requests_bridge",
    "identity_bridge",
    "infrastructure_sector_bridge",
    "intelligence_bi_sources_bridge",
    "justice_public_safety_bridge",
    "resources_agricultura_bridge",
    "resources_external_services_bridge",
    "service_requests_bridge",
    "society_domain_enums_bridge",
    "society_repository_bridges",
    "society_statistics_models_bridge",
]
for _mod in _SUBMODULES:
    sys.modules[f"{__name__}.{_mod}"] = import_module(f"apps.backend.app.core.bridges.{_mod}")
