...
CREATE_INDEX_AGGREGATE_ID = (
    "CREATE INDEX IF NOT EXISTS ix_aggregate_id ON event_store(aggregate_id);"
)
CREATE_INDEX_AGGREGATE_TYPE = (
    "CREATE INDEX IF NOT EXISTS ix_aggregate_type ON event_store(aggregate_type);"
)
...
CREATE_INDEX_AGGREGATE_TIMESTAMP = (
    "CREATE INDEX IF NOT EXISTS ix_aggregate_id_timestamp ON event_store(aggregate_id, timestamp);"
)
CREATE_INDEX_EVENT_TYPE_TIMESTAMP = (
    "CREATE INDEX IF NOT EXISTS ix_event_type_timestamp ON event_store(event_type, timestamp);"
)
...
CREATE_INDEXES = [
    CREATE_INDEX_AGGREGATE_ID,
    CREATE_INDEX_AGGREGATE_TYPE,
    CREATE_INDEX_EVENT_TYPE,
    CREATE_INDEX_TIMESTAMP,
    CREATE_INDEX_AGGREGATE_TIMESTAMP,
    CREATE_INDEX_EVENT_TYPE_TIMESTAMP,
    CREATE_INDEX_AGGREGATE_TYPE_TIMESTAMP,
]
