"""policies.py - placeholder para regras de acesso

Arquivo mínimo, consistente e extensível para desbloquear o arranque
do servidor. Não contém lógica de negócio; serve como ponto único
para implementar/verificar regras de autorização.
"""
...
class DataSegment(str, Enum):
    ...
    def allows(self, action: str) -> bool:
        # Placeholder permissivo — substituir por regras reais quando necessário.
        return True
...
# Minimal SQLAlchemy model and DTOs to satisfy access_control imports.
# These are placeholders and should be replaced by the real application
# models/validation logic in the proper module when available.
