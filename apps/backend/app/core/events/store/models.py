...
from sqlalchemy import Column, String, Integer, JSON, DateTime, Index, UniqueConstraint, func
...
class EventStoreEntry(Base):
    ...
    __table_args__ = (Index('ix_event_store_aggregate_version', 'aggregate_id', 'version', unique=True), Index('ix_event_store_type_created', 'event_type', 'created_at'), Index('ix_event_store_aggregate_type', 'aggregate_type'), UniqueConstraint('aggregate_id', 'version', name='uq_event_store_version'))
