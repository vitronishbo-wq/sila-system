...
class RedisBroker:
    ...
    def __init__(self):
        ...
        """
        try:
            self.client = redis.Redis.from_url(settings.REDIS_URL, decode_responses=True, auto_close_conn_pool=False)
    ...
    async def publish(self, channel: str, message: dict) -> int:
        ...
        try:
            ...
            logger.info('event_published_redis', extra={'channel': channel, 'subscribers': subscribers_count})
