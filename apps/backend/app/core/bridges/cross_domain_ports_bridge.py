...
from apps.backend.app.modules.resources.agricultura.application.ports.produtor_repository_port import ProdutorRepositoryPort
...
from apps.backend.app.modules.educacao.application.ports.matricula_repository_port import MatriculaRepositoryPort
from apps.backend.app.modules.educacao.application.ports.propina_repository_port import PropinaRepositoryPort
from apps.backend.app.modules.society.emprego.application.ports.candidato_repository_port import CandidatoRepositoryPort
from apps.backend.app.modules.society.emprego.application.ports.contrato_repository_port import ContratoRepositoryPort
