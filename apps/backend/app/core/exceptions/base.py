...
class SilaException(Exception):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {'error': self.code, 'message': self.message, 'status_code': self.status_code, 'details': self.details}
...
class ValidationException(SilaException):
    ...
    def __init__(self, message: str='Validação falhou', details: Optional[Dict[str, Any]]=None):
...
class BusinessLogicException(SilaException):
    ...
    def __init__(self, message: str, details: Optional[Dict[str, Any]]=None):
        super().__init__(message=message, code='BUSINESS_RULE_VIOLATION', status_code=422, details=details)
...
class ForbiddenException(SilaException):
    ...
    def __init__(self, message: str='Acesso proibido', details: Optional[Dict[str, Any]]=None):
...
class ConflictException(SilaException):
    ...
    def __init__(self, message: str='Recurso em conflito', details: Optional[Dict[str, Any]]=None):
...
class ExternalServiceException(SilaException):
    ...
    def __init__(self, message: str='Serviço externo indisponível', details: Optional[Dict[str, Any]]=None):
        super().__init__(message=message, code='EXTERNAL_SERVICE_ERROR', status_code=503, details=details)
...
__all__ = ['SilaException', 'NotFoundException', 'ValidationException', 'BusinessLogicException', 'UnauthorizedException', 'ForbiddenException', 'ConflictException', 'ExternalServiceException']