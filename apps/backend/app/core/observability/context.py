...
Uso:
    from app.core.observability.context import get_request_id, set_request_context
...
_territory_id_var: contextvars.ContextVar[Optional[str]] = contextvars.ContextVar('territory_id', default=None)
_user_roles_var: contextvars.ContextVar[Tuple[str, ...]] = contextvars.ContextVar('user_roles', default=())
_service_name_var: contextvars.ContextVar[Optional[str]] = contextvars.ContextVar('service_name', default=None)
...
_start_time_var: contextvars.ContextVar[Optional[datetime]] = contextvars.ContextVar('start_time', default=None)

def generate_request_id() -> str:
    """Gera um novo request_id único (UUID v4 comprimido)."""
    return str(uuid.uuid4())

def set_request_context(request_id: Optional[str]=None, user_id: Optional[str]=None, tenant_id: Optional[str]=None, territory_id: Optional[str]=None, service_name: Optional[str]=None, trace_id: Optional[str]=None, span_id: Optional[str]=None, user_roles: Optional[Iterable[str]]=None) -> str:
    """
...
def set_security_context(user_id: Optional[str]=None, tenant_id: Optional[str]=None, roles: Optional[Iterable[str]]=None, request_id: Optional[str]=None) -> str:
    """
...
def get_territory_id() -> Optional[str]:
...
def get_context_dict() -> Dict[str, Any]:
    ...
    """
    return {'request_id': get_request_id(), 'user_id': get_user_id(), 'tenant_id': get_tenant_id(), 'territory_id': get_territory_id(), 'user_roles': list(get_user_roles() or ()), 'service_name': get_service_name(), 'trace_id': get_trace_id(), 'span_id': get_span_id(), 'duration_ms': get_duration_ms()}
...
__all__ = ['generate_request_id', 'set_request_context', 'set_security_context', 'get_request_id', 'get_user_id', 'get_tenant_id', 'get_territory_id', 'get_user_roles', 'get_service_name', 'get_trace_id', 'get_span_id', 'get_start_time', 'get_duration_ms', 'get_context_dict', 'clear_context']