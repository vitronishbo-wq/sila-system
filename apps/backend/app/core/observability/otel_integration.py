...
Uso:
    from apps.backend.app.core.observability.otel_integration import setup_otel_tracing
    ...
    resource = Resource.create(
        {
            ...
            "service.version": os.getenv("SILA_VERSION", "3.0.0"),
...
def create_span_with_context(name: str, attributes: dict | None = None) -> trace.Span | None:
    """
