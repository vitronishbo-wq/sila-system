...
SLA_DEFINITIONS = {
    ...
    "EDUCATION_ENROLLMENT": {
        ...
        "critical_threshold_seconds": 4.0,
    },
    "EDUCATION_TRANSFER": {
        "description": "Educação - Transferência Escolar",
        "target_sla_seconds": 3.0,
        "warning_threshold_seconds": 1.5,
        "critical_threshold_seconds": 5.0,
    },
    "EDUCATION_ELIGIBILITY_CHECK": {
        "description": "Educação - Verificação de elegibilidade",
        "target_sla_seconds": 0.5,
        "warning_threshold_seconds": 0.25,
        "critical_threshold_seconds": 1.0,
    },
    "EDUCATION_CERTIFICATE": {
        "description": "Educação - Emissão de Certificado",
        "target_sla_seconds": 2.0,
        "warning_threshold_seconds": 1.0,
        "critical_threshold_seconds": 4.0,
    },
