...
def upgrade() -> None:
    op.create_table(
        ...
        sa.CheckConstraint("latitude >= -90 AND latitude <= 90", name="ck_meteorologia_estacoes_latitude"),
        sa.CheckConstraint("longitude >= -180 AND longitude <= 180", name="ck_meteorologia_estacoes_longitude"),
    )
    op.create_index("ix_meteorologia_estacoes_codigo", "meteorologia_estacoes", ["codigo"], unique=True)
    op.create_index("ix_meteorologia_estacoes_status", "meteorologia_estacoes", ["status"], unique=False)
    op.create_index("ix_meteorologia_estacoes_municipio", "meteorologia_estacoes", ["municipio"], unique=False)
    op.create_index("ix_meteorologia_estacoes_provincia", "meteorologia_estacoes", ["provincia"], unique=False)
    op.create_index("ix_meteorologia_estacoes_deleted_at", "meteorologia_estacoes", ["deleted_at"], unique=False)
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column("qualidade_dados", sa.String(length=20), nullable=False, server_default="VALIDADO"),
    ...
    op.create_index("ix_meteorologia_observacoes_estacao_id", "meteorologia_observacoes", ["estacao_id"], unique=False)
    op.create_index("ix_meteorologia_observacoes_data_observacao", "meteorologia_observacoes", ["data_observacao"], unique=False)
    op.create_index("ix_meteorologia_observacoes_has_alerts", "meteorologia_observacoes", ["has_alerts"], unique=False)
    op.create_index("ix_meteorologia_observacoes_created_at", "meteorologia_observacoes", ["created_at"], unique=False)
    op.create_index(
...
def downgrade() -> None:
    ...
    op.drop_index("ix_meteorologia_observacoes_data_observacao", table_name="meteorologia_observacoes")
