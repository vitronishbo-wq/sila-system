...
def upgrade() -> None:
    ...
    op.create_table(
        'economy_payments',
        sa.Column('id', sa.String(36), primary_key=True),
        sa.Column('invoice_id', sa.String(36), sa.ForeignKey('economy_invoices.id', ondelete='CASCADE'), nullable=False),
        sa.Column('citizen_id', sa.String(64), nullable=False),
        sa.Column('amount', sa.Numeric(14, 2), nullable=False),
        sa.Column('currency', sa.String(3), nullable=False),
    ...
    op.create_index('ix_economy_payments_gateway_reference', 'economy_payments', ['gateway_reference'], unique=True)
