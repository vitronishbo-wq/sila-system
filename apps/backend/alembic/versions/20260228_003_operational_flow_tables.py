...
def upgrade():
    ...
    op.execute(
        "CREATE INDEX IF NOT EXISTS ix_operational_orders_citizen_id ON operational_orders (citizen_id)"
    )
    op.execute(
        "CREATE INDEX IF NOT EXISTS ix_operational_orders_service_id ON operational_orders (service_id)"
    )
    op.execute(
        "CREATE INDEX IF NOT EXISTS ix_operational_orders_status ON operational_orders (status)"
    )
    op.execute(
    ...
    op.execute(
        "CREATE INDEX IF NOT EXISTS ix_operational_payments_order_id ON operational_payments (order_id)"
    )
    op.execute(
        "CREATE INDEX IF NOT EXISTS ix_operational_payments_reference ON operational_payments (reference)"
    )
    op.execute(
        "CREATE INDEX IF NOT EXISTS ix_operational_payments_status ON operational_payments (status)"
    )
