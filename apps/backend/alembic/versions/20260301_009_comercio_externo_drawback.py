"""create comercio_externo_drawback and comercio_externo_drawback_suspensao tables

Revision ID: 20260301_009_comex_drawback
Revises: 20260301_008_pecuaria_foundation
...
revision = "20260301_009_comex_drawback"
down_revision = "20260301_008_pecuaria_foundation"
branch_labels = None
depends_on = None


def _create_operador_table(*, table_name: str, suffix: str, tipo_operador: str) -> None:
    op.execute(
        f"""
...
def _drop_operador_table(*, table_name: str) -> None:
...
def upgrade():
    _create_operador_table(
        table_name="comercio_externo_drawback",
        suffix="comex_drawback",
        tipo_operador="exportador_importador",
    )
    _create_habilitacao_table(
        table_name="comercio_externo_drawback_suspensao",
        suffix="comex_drawback_suspensao",
        tipo_operador="exportador_importador",
    )


def downgrade():
    _drop_habilitacao_table(table_name="comercio_externo_drawback_suspensao")
    _drop_operador_table(table_name="comercio_externo_drawback")
