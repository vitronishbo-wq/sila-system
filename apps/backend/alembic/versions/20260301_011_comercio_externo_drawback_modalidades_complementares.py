"""create comercio_externo_drawback_substituicao and drawback_integrado tables

Revision ID: 20260301_011_comex_drawback_modalidades_complementares
Revises: 20260301_010_comex_drawback_modalidades
...
revision = "20260301_011_comex_drawback_modalidades_complementares"
down_revision = "20260301_010_comex_drawback_modalidades"
branch_labels = None
depends_on = None
...
def upgrade():
    _create_habilitacao_table(
        table_name="comercio_externo_drawback_substituicao",
        suffix="comex_drawback_substituicao",
        tipo_operador="exportador_importador",
    )
    _create_habilitacao_table(
        table_name="comercio_externo_drawback_integrado",
        suffix="comex_drawback_integrado",
        tipo_operador="exportador_importador",
    )


def downgrade():
    _drop_habilitacao_table(table_name="comercio_externo_drawback_integrado")
    _drop_habilitacao_table(table_name="comercio_externo_drawback_substituicao")
