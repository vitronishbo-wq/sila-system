...
def upgrade():
    ...
    op.create_index(
        op.f("ix_saude_requests_citizen_id"), "saude_requests", ["citizen_id"], unique=False
    )
    op.create_index(
        op.f("ix_saude_requests_service_type"), "saude_requests", ["service_type"], unique=False
    )
    op.create_index(op.f("ix_saude_requests_status"), "saude_requests", ["status"], unique=False)
    op.create_index(
        "ix_saude_requests_citizen_status", "saude_requests", ["citizen_id", "status"], unique=False
    )
