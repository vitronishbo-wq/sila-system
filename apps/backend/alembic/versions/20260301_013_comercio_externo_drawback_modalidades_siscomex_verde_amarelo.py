"""create comercio_externo_drawback_verde_amarelo and siscomex_drawback tables

Revision ID: 20260301_013_comex_drawback_modalidades_siscomex_verde_amarelo
Revises: 20260301_012_comex_drawback_modalidades_externo_interno
Create Date: 2026-03-01 23:59:30.000000
"""
...
revision = "20260301_013_comex_drawback_modalidades_siscomex_verde_amarelo"
down_revision = "20260301_012_comex_drawback_modalidades_externo_interno"
branch_labels = None
depends_on = None
...
def upgrade():
    _create_habilitacao_table(
        table_name="comercio_externo_drawback_verde_amarelo",
        suffix="comex_drawback_verde_amarelo",
        tipo_operador="exportador_importador",
    )
    _create_habilitacao_table(
        table_name="comercio_externo_siscomex_drawback",
        suffix="comex_siscomex_drawback",
        tipo_operador="exportador_importador",
    )


def downgrade():
    _drop_habilitacao_table(table_name="comercio_externo_siscomex_drawback")
    _drop_habilitacao_table(table_name="comercio_externo_drawback_verde_amarelo")
