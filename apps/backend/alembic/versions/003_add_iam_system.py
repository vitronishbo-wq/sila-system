...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['citizen_id'], ['citizenship_citizens.id'], ondelete='SET NULL'),
    )
    op.create_index('ix_iam_users_status_created', 'iam_users', ['status', 'created_at'], unique=False)
    op.create_index('ix_iam_users_username_lower', 'iam_users', [sa.func.lower(sa.column('username'))], unique=False)
    op.create_index('ix_iam_users_email_lower', 'iam_users', [sa.func.lower(sa.column('email'))], unique=False)
    ...
    op.create_index('ix_iam_role_permissions_role_id', 'iam_role_permissions', ['role_id'], unique=False)
    op.create_index('ix_iam_role_permissions_permission_id', 'iam_role_permissions', ['permission_id'], unique=False)
    ...
    op.create_index('ix_iam_user_permissions_user_id', 'iam_user_permissions', ['user_id'], unique=False)
    op.create_index('ix_iam_user_permissions_permission_id', 'iam_user_permissions', ['permission_id'], unique=False)
