        ...
        try:
            ...
            for u in users:
                ...
                processed_users.append(
                    {
                        "level": u.administrative_level.value
                        if hasattr(u.administrative_level, "value")
                        else str(u.administrative_level),
                        "email": u.email,
...
if __name__ == "__main__":
    target_path = (
        "/app/scripts/administrative_users.csv"
        if os.path.exists("/app/scripts")
        else "administrative_users.csv"
    )
