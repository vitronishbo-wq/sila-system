    ...
    def test_module_has_exception_base_class(self):
        ...
        for module_name in modules_to_test:
            try:
                ...
                assert hasattr(exc_module, 'DomainException') or \
                       hasattr(exc_module, 'Exception'), \
...
class TestDomainServiceLocations:
    ...
    def test_domain_services_exist(self):
        ...
        services_dir = Path(__file__).parent.parent.parent / "app" / "modules" / "justice" / "domain" / "services"
