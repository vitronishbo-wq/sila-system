...
Módulo responsável pelas funcionalidades relacionadas a ADDRESS no sistema SILA.
...
DELETE | /address/\* | Operações CRUD básicas |
...
```python
from app.modules.address import router
