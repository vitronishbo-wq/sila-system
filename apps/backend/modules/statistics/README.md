...
Módulo responsável pelas funcionalidades relacionadas a STATISTICS no sistema SILA.
...
DELETE | /statistics/\* | Operações CRUD básicas |
...
```python
from app.modules.statistics import router
