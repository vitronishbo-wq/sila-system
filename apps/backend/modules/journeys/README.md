...
Módulo responsável pelas funcionalidades relacionadas a JOURNEYS no sistema SILA.
...
DELETE | /journeys/\* | Operações CRUD básicas |
...
```python
from app.modules.journeys import router
