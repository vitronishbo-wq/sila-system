...
class RequestFactory:
    ...
    @classmethod
    def create_draft(cls, citizen_id: UUID, created_by: UUID,
    ...
    @classmethod
    def create_submitted(cls, citizen_id: UUID, created_by: UUID,
                         service_type: ServiceType, title: str,
                         description: Optional[str] = None,
                         channel: RequestChannel = RequestChannel.WEB,
                         priority: RequestPriority = RequestPriority.MEDIUM,
    ...
    def from_workflow(cls, workflow_data: Dict[str, Any]) -> ServiceRequest:
        ...
        return ServiceRequest(
            ...
            status=ServiceRequestStatus(workflow_data.get('status', 'RASCUNHO')),
            channel=RequestChannel(workflow_data.get('channel', 'WEB')),
            priority=RequestPriority(workflow_data.get('priority', 'MEDIA')),
