...
Módulo responsável pelas funcionalidades relacionadas a URBANISM no sistema SILA.
...
DELETE | /urbanism/\* | Operações CRUD básicas |
...
```python
from app.modules.urbanism import router
