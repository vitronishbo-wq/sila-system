...
Módulo responsável pelas funcionalidades relacionadas a PAYMENT no sistema SILA.
...
DELETE | /payment/\* | Operações CRUD básicas |
...
```python
from app.modules.payment import router
