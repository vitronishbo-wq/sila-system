...
Módulo responsável pelas funcionalidades relacionadas a GOVERNANCE no sistema SILA.
...
DELETE | /governance/\* | Operações CRUD básicas |
...
```python
from app.modules.governance import router
