...
async def test_register_birth_success(client, db_session):
    payload = {'nub': f'NUB-{uuid.uuid4().hex[:8]}', 'full_name': 'Junior dos Santos', 'date_of_birth': '2026-02-01T10:00:00', 'place_of_birth': 'Luanda', 'mother_name': 'Maria dos Santos'}
