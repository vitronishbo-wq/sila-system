...
class TestBIRoutes:
    ...
    def test_emit_bi_requires_citizen_fuc_id(self):
        ...
        response = client.post('/api/v1/identidade/bi/emit', json={})
    ...
    def test_emit_bi_with_invalid_citizen_returns_error(self):
        ...
        response = client.post('/api/v1/identidade/bi/emit', json={'citizen_fuc_id': 'INEXISTENT-FUC-ID-12345'})
        assert response.status_code in (400, 404)

    def test_cancel_bi_requires_reason(self):
        """Deve exigir motivo para cancelamento."""
        response = client.post('/api/v1/identidade/bi/cancel/001234567LA001', json={})
        assert response.status_code == 400
...
class TestRenewalRoute:
    ...
    def test_renew_bi_with_invalid_citizen(self):
        """Deve retornar erro para cidadão inexistente."""
        response = client.post('/api/v1/identidade/bi/renew/001234567LA001', json={'citizen_fuc_id': 'INVALID-ID'})
