...
class TestCitizenEntity:
    ...
    def test_citizen_creation_with_defaults(self):
        ...
        citizen = Citizen(citizen_id=uuid4(), full_name='Test User')
    ...
    def test_citizen_from_fuc_projection_with_missing_fields(self):
        ...
        fuc_data = {'id': str(uuid4()), 'full_name': 'Incomplete User'}
    ...
    def test_citizen_equality(self):
        ...
        citizen_id = uuid4()
        citizen1 = Citizen(citizen_id=citizen_id, full_name='Same User')
        citizen2 = Citizen(citizen_id=citizen_id, full_name='Same User')
        assert citizen1 == citizen2

    def test_citizen_with_incomplete_data(self):
        """Testa criação com dados incompletos."""
        citizen = Citizen(citizen_id=uuid4(), full_name='Only Name')
...
class TestCitizenValidation:
    ...
    def test_citizen_gender_values(self):
        ...
        for gender in genders:
            citizen = Citizen(citizen_id=uuid4(), full_name='Test', gender=gender)
    ...
    def test_citizen_vital_status_values(self):
        ...
        for status in statuses:
            citizen = Citizen(citizen_id=uuid4(), full_name='Test', vital_status=status)
...
class TestCitizenDataTransformation:
    ...
    def test_citizen_immutability_options(self):
        ...
        citizen = Citizen(citizen_id=uuid4(), full_name='Immutable Test')
