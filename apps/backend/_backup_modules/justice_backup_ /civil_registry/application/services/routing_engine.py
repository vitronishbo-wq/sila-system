...
class RequestState(str, Enum):
    ...
    def initial_states(cls):
        ...
        return [cls.EM_ANALISE_COMUNAL, cls.EM_ANALISE_MUNICIPAL, cls.EM_ANALISE_PROVINCIAL, cls.EM_ANALISE_CENTRAL]
    ...
    def waiting_states(cls):
        ...
        return [cls.AGUARDANDO_CIDADAO_COMUNAL, cls.AGUARDANDO_CIDADAO_MUNICIPAL, cls.AGUARDANDO_CIDADAO_PROVINCIAL]
...
class RoutingEngine:
    ...
    def _apply_routing_rules(self, territory, service, routing_rule: RoutingRule, request_data: dict) -> RoutingDecision:
        ...
        if routing_rule == RoutingRule.COMUNA_ONLY:
            ...
            return RoutingDecision(target_territory_id=commune.id, target_territory_type='COMUNA', target_territory_name=commune.name, initial_state=RequestState.EM_ANALISE_COMUNAL, justification='Serviço com competência exclusiva comunal', routing_path=['BAIRRO', 'COMUNA'], competence_level='COMUNA_ONLY')
        return None
