...
from apps.backend.app.modules.justice.bounded_contexts.vital_events.application.services.birth_service import BirthService
from apps.backend.app.modules.justice.bounded_contexts.vital_events.infrastructure.repositories.birth_repository import BirthRepository
from apps.backend.app.modules.justice.bounded_contexts.civil_registry_core.infrastructure.repositories.citizen_repository import CitizenRepository
