...
paths_to_check = [
    ...
    ("app/core/intelligence/predictive_governance/application/policy_predictor.py", "Policy Predictor"),
    ...
    ("app/core/intelligence/national_analytics/application/analytics_engine.py", "Analytics Engine"),
