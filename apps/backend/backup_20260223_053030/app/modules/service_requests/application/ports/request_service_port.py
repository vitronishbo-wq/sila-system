...
class RequestServicePort(ABC):
    ...
    @abstractmethod
    def create_request(self, citizen_id: UUID, created_by: UUID,
    ...
    @abstractmethod
    def list_operator_requests(self, user_id: UUID, status: Optional[str] = None,
    ...
    @abstractmethod
    def change_status(self, request_id: UUID, new_status: str,
