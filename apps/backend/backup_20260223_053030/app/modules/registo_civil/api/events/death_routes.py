...
from app.modules.registo_civil.application.services.death_service import DeathService
...
def get_death_service(db=Depends(get_db)):
    from app.modules.registo_civil.infrastructure.repositories.death_repository import DeathRepository
