...
class TaxDeclarationFiled:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "deductions": str(self.deductions) if self.deductions else None,
    ...
    def __str__(self) -> str:
        ...
        return (
            f"TaxDeclarationFiled(declaration_number={self.declaration_number}, "
            f"tax_type={self.tax_type}, period={self.tax_period}, "
