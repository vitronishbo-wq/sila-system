...
class TaxDebtCreated:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "interest": str(self.interest) if self.interest else None,
            "fines": str(self.fines) if self.fines else None,
            "created_date": self.created_date.isoformat(),
            "due_date": self.due_date.isoformat() if self.due_date else None,
            "reason": self.reason,
            "related_declaration_id": str(self.related_declaration_id)
            if self.related_declaration_id
            else None,
    ...
    def __str__(self) -> str:
        ...
        return (
            f"TaxDebtCreated(debt_number={self.debt_number}, "
            f"tax_type={self.tax_type}, amount={self.current_amount} {self.currency}, "
