...
class NIF:
    ...
    def __post_init__(self) -> None:
        ...
        if not self._is_valid(self.value):
            raise ValueError(
                f"NIF inválido: {self.value}. "
                "Deve ter 9 ou 14 dígitos."
            )
    ...
    def from_string(cls, nif_string: str) -> "NIF":
        ...
        """
        # Remove formatação common (hífens, espaços)
    ...
    def is_valid_checksum(self) -> bool:
        ...
        """
        # TODO: Implementar validação de checksum quando AGT publicar especificações
        # Esta é uma placeholder para evolução futura da validação
        return True
