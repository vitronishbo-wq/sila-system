...
from app.modules.workflow.domain.enums import TransitionType, AssignmentType
...
class WorkflowTransition:
    ...
    assignment_value: Optional[str] = None  # role, user_id, group, expression
    
    # Condições
    condition_expression: Optional[str] = None  # Expressão para avaliar
