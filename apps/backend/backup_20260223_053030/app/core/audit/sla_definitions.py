...
SLA_DEFINITIONS = {
    "BI_EMISSAO": {
        ...
        "target_sla_seconds": 172800,   # 48h
        "warning_threshold_seconds": 86400,  # 24h (alerta amarelo)
        "critical_threshold_seconds": 259200, # 72h (alerta vermelho)
    },
    "CERTIDAO_NASCIMENTO": {
        "description": "Certidão de Nascimento",
        "target_sla_seconds": 86400,    # 24h
    ...
    "CERTIDAO_OBITO": {
        ...
        "target_sla_seconds": 43200,    # 12h (urgente)
        "warning_threshold_seconds": 21600,
        "critical_threshold_seconds": 86400,
    },
    "DEFAULT": {
        "description": "Serviço Genérico",
        "target_sla_seconds": 259200,   # 72h
        "warning_threshold_seconds": 172800,
        "critical_threshold_seconds": 432000,  # 5 dias
    },
}

# Anomaly Thresholds (eventos por janela de tempo)
ANOMALY_THRESHOLDS = {
    "FILE_DELETED": {"window_minutes": 60, "max_count": 20, "severity": "HIGH"},
    "REQUEST_STATUS_UPDATED": {"window_minutes": 5, "max_count": 100, "severity": "MEDIUM"},
    "FILE_UPLOADED": {"window_minutes": 10, "max_count": 200, "severity": "INFO"},
}

# SLO Targets (percentuais)
SLO_TARGETS = {
    "availability": 99.5,          # % uptime
    "request_completion_rate": 95.0, # % pedidos completados dentro do SLA
    "error_rate_max": 1.0,          # % máximo de erros
}
