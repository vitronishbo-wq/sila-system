...
const Dashboard: React.FC<DashboardProps> = ({ user }) => {
  ...
  const displayName = user.username || user.email || 'utilizador';
  const levelValue = String(user.level || AdminLevel.CENTRAL).toLowerCase();
  ...
  const levelImages: Record<string, string> = {
    [AdminLevel.CENTRAL]: IMAGES.GEO_LEVELS.NATIONAL,
    [AdminLevel.PROVINCIAL]: IMAGES.GEO_LEVELS.PROVINCIAL,
    [AdminLevel.MUNICIPAL]: IMAGES.GEO_LEVELS.MUNICIPAL,
    [AdminLevel.COMMUNAL]: IMAGES.GEO_LEVELS.MUNICIPAL,
    [AdminLevel.SUPER]: IMAGES.GEO_LEVELS.NATIONAL,
  };
  ...
  return (
    <div className="space-y-8 relative">
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-2xl p-8 text-white shadow-xl">
        <img
          src={levelImages[levelValue] || IMAGES.GEO_LEVELS.NATIONAL}
        ...
        <div className="relative z-10 flex items-start justify-between">
          <div className="max-w-2xl">
            ...
            <h1 className="text-3xl font-bold mb-2">
              Bom dia, <span className="text-yellow-400">{displayName}</span>
            </h1>
