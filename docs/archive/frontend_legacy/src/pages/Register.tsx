        ...
        <div className="min-h-screen flex bg-white font-inter">
            ...
            <div className="hidden lg:flex lg:w-1/2 relative bg-slate-900 overflow-hidden">
                ...
                <div className="relative z-10 w-full p-16 flex flex-col justify-end text-white">
                    <div className="mb-12">
                        <img src={IMAGES.BRAND.INSIGNIA} alt="Brasão" className="w-24 mb-6 shadow-2xl" />
                    ...
                    {!success && (
                        <div className="mt-12 pt-8 border-t text-center text-gray-400 text-xs">
                            <div className="flex justify-center gap-4">
                                <img src={IMAGES.BRAND.INSIGNIA} alt="MAT" className="h-6 opacity-40 grayscale" />
