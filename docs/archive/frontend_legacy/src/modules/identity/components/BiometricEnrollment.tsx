...
type BiometricType = 'FINGERPRINT' | 'FACE_RECOGNITION' | 'IRIS' | 'VOICE';
...
export const BiometricEnrollment: React.FC<BiometricEnrollmentProps> = ({
  ...
  const [step, setStep] = useState<'type-selection' | 'capture' | 'review' | 'uploading'>('type-selection');
  ...
  return (
    <div>
      <p className="text-gray-600 mb-6">
        {instructions[biometricType as BiometricType] || 'Instruções'}
      </p>
