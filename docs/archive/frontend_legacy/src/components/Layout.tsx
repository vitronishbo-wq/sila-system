    ...
    <div className="min-h-screen flex bg-gray-100">
      ...
      <aside className={`bg-slate-900 text-white transition-all duration-300 ${isSidebarOpen ? 'w-64' : 'w-20'} flex flex-col`}>
        <div className="p-4 flex items-center gap-3 border-b border-slate-800">
          <img src={IMAGES.BRAND.INSIGNIA} alt="SILA" className="w-8 h-8 object-contain" />
          ...
          <div className="flex items-center gap-5">
            ...
            <div className="flex items-center gap-3">
              <div className="text-right">
                ...
                <p className="text-xs text-gray-500 uppercase">{String(user.role || 'user').replace('ADMIN_', '')}</p>
              </div>
